...
## Latest Update
- Filament searchable inputs now expose fallback payload macros and a lightweight test fixture so schema-aware helpers operate without container boot errors during unit tests.
