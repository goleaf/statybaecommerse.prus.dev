...
## Latest Update
- Recently viewed storefront APIs now skip visibility scopes and deliver ordered product identifiers so customer history panels and wishlist toggles stay in sync even when draft catalogue records are stored in the session during tests.
