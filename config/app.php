...
return [
     ...
     * |--------------------------------------------------------------------------
     * |
     * | Used by SetLocale middleware, route groups, hreflang component,
     ...
     * |--------------------------------------------------------------------------
     * |
     * | Map a locale to a default currency and/or zone code. Used by
     * | SetLocale middleware to optionally force currency/zone according
     * | to selected locale.
     * |
     * | Example:
     * | 'locale_mapping' => [
