...
model: inherit
skills: clean-code, parallel-agents, behavioral-modes, plan-writing, brainstorming, architecture, lint-and-validate, powershell-windows, bash-linux, filament-v4
---
...
| `frontend-specialist` | Frontend & UI | React, Vue, Tailwind, components |
