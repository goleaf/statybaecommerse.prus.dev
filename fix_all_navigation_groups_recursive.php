...
/** Comprehensive fix for all Filament v4 navigation group issues (recursive) */
$resourceFiles = glob('app/Filament/Resources/**/*.php');

echo "Fixing all navigation group issues (recursive)...\n";
...
echo "All navigation group fixes completed (recursive).\n";
