...
### Bug Fixes
* Normalized notification API mutations to drop redundant message keys and cast rate limiting headers to strings so Symfony no longer throws `ResponseHeaderBag::set()` type errors during throttled requests.
