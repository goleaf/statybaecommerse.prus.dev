...
* Restored the Husky bootstrap shim so Git hooks keep running repository-configured QA checks while still broadcasting the upstream deprecation warning ahead of v10.
