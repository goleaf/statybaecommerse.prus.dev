...
### Bug Fixes
* Rebuilt the VariantImage model scopes, accessors, and metadata helpers so admin pages and tests can toggle activation, format file information, and keep variant image ordering consistent.
