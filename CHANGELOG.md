...
### Maintenance
* Added repository automation for dependency hygiene, introducing Dependabot scheduling, default labels, and guarded auto-merge gates for safer bot-driven updates.
