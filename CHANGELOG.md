...
### Bug Fixes
* Stabilized campaign click API factories by guarding related lookups and aligning PHPUnit with the shared SQLite database so regression tests no longer fail with missing-table errors during fresh runs.
