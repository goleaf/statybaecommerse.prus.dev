...
- [ ] Audit all `app/Filament/**` PHP files for legacy `form`/`table` signatures *(2025-10-24 — active sprint)*
- [ ] Standardize `Schema` and `Table` imports and method signatures *(2025-10-24 — active sprint)*
...
- [ ] Document bilingual release notes after batch normalization *(2025-10-24)*
...
- [x] Investigate `MenuResourceTest` suite failures (listing, creation, editing, deletion, filters, bulk actions) and restore full coverage with bilingual translations and Filament v4 schema/table compliance. // added 2025-10-24 — new Filament v4 Livewire suites created in `tests/Feature/Filament/Resources/MenuResourceTest.php` and `MenuItemResourceTest.php`.
