...
final class DiscountCodeDocumentActionUnitTest extends TestCase
{
    public function test_discount_code_document_action_class_exists(): void
    {
        expect(class_exists(DiscountCodeDocumentAction::class))
            ->toBeTrue();
    }
