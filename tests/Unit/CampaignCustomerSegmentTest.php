...
final class CampaignCustomerSegmentTest extends TestCase
{
    ...
    public function test_belongs_to_campaign(): void
    {
        $segment = CampaignCustomerSegment::factory()
            ->for($this->campaign)
            ->state(['customer_group_id' => $this->customerGroup->id])
            ->create();
    ...
    public function test_can_scope_by_campaign(): void
    {
        ...
        $segment1 = CampaignCustomerSegment::factory()
            ->for($this->campaign)
            ->state(['customer_group_id' => $this->customerGroup->id])
            ->create();

        $segment2 = CampaignCustomerSegment::factory()
            ->for($campaign2)
            ->state(['customer_group_id' => $this->customerGroup->id])
            ->create();
    ...
    public function test_can_scope_by_customer_group(): void
    {
        ...
        $segment2 = CampaignCustomerSegment::factory()
            ->for($this->campaign)
            ->state(['customer_group_id' => $customerGroup2->id])
            ->create();
    ...
    public function test_can_order_by_sort_order(): void
    {
        ...
        $segment3 = CampaignCustomerSegment::factory()
            ->for($this->campaign)
            ->state(['customer_group_id' => $this->customerGroup->id])
            ->create([
                'sort_order' => 2,
