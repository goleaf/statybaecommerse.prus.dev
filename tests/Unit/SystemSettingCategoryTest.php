...
class SystemSettingCategoryTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_get_settings_count(): void
    {
        ...
        // Note: This would require SystemSetting model and factory
        // For now, test that the method exists and returns an integer
        $this->assertIsInt($category->getSettingsCount());
        $this->assertEquals(0, $category->getSettingsCount());
    }
    ...
    public function test_get_parent(): void
    {
        ...
        $this->assertNull($parentCategory->getParent());
    }
    ...
    public function test_get_children(): void
    {
        ...
        $this->assertCount(2, $children); // Only active children
        $this->assertEquals($child2->id, $children->first()->id); // Sorted by sort_order
    }
