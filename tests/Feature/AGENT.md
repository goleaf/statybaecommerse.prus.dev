...
- Keep guard coverage under `tests/Feature/Seeders/AdminAuthorizationSeederTest.php` aligned with any changes to
  `authorization.guards` so seeded permissions remain fully verified.
