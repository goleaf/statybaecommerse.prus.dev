...
class PHPDocCommand extends Command
{
    ...
    protected $signature = 'docs:generate 
                            {--upgrade : Upgrade PHPDoc comments before generating}
                            {--clean : Clean existing documentation first}
                            {--serve : Serve documentation after generation}
                            {--port=8080 : Port for serving documentation}';
    ...
    {
        $this->info('🚀 Starting PHPDoc Documentation Generation...');
        $this->newLine();
    ...
    private function cleanDocumentation(): void
    {
        ...
        if (File::exists($docsDir)) {
            ...
            $this->line('   Removed docs directory');
        }

        $this->info('✅ Documentation cleaned');
    }

    /**
     * Upgrade PHPDoc comments.
     */
    private function upgradePHPDoc(): void
    {
        $this->info('⬆️  Upgrading PHPDoc comments...');
        $this->newLine();
