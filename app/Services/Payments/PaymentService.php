...
final class PaymentService
{
    ...
    public function process(Order $order, array $paymentData = []): array
    {
        ...
        $tx = ['id' => (string) uniqid($provider . '_', true), 'provider' => $provider, 'status' => $txnStatus, 'amount' => (float) $order->grand_total_amount, 'currency' => 'EUR', 'created_at' => now()->toIso8601String(), 'meta' => $paymentData];
