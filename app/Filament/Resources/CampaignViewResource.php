        ...
        return $table
            ->columns([
                ...
                TextColumn::make('user_agent')
                    ...
                    ->tooltip(function (TextColumn $column): ?string {
                        ...
                        if (! is_string($state)) {
                            // Non-string values should not trigger a tooltip.
                            return null;
                        }
            ...
            ->filters([
                ...
                SelectFilter::make('ip_address')
                    ->label(__('campaign_views.ip_address'))
                    // Provide a deduplicated list of IP addresses so operators can filter without typing free-form values.
                    ->options(
                        fn (): array => CampaignView::query()
                            ->distinct('ip_address')
