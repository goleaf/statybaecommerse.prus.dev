...
class UserForm
{
    ...
    private static function prepareCustomerGroupPayload(array $data): array
    {
        return [
            ...
            'discount_percentage'  => self::nullableFloat($data['discount_percentage'] ?? null) ?? 0.0,
            'discount_fixed'       => self::nullableFloat($data['discount_fixed'] ?? null) ?? 0.0,
            ...
            'minimum_order_amount' => self::nullableFloat($data['minimum_order_amount'] ?? null) ?? 0.0,
            'credit_limit'         => self::nullableFloat($data['credit_limit'] ?? null) ?? 0.0,
