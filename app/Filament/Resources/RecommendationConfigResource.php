...
final class RecommendationConfigResource extends Resource
{
    ...
    public static function form(Schema $schema): Schema {
        return $schema->schema([
                ...
                Forms\Components\Section::make(__('translations.recommendation_config_algorithm'))
                    ->schema([
                ...
                Forms\Components\Section::make(__('translations.recommendation_config_filters'))
                    ->schema([
                ...
                Forms\Components\Section::make(__('translations.recommendation_config_limits'))
                    ->schema([
                        Forms\Components\Grid::make(3)
                            ->schema([
                                Forms\Components\TextInput::make('max_results')
                                    ...
                                    ->minValue(1)
                                    ->maxValue(50)
                                    ->helperText(__('translations.recommendation_config_max_results_help')),
                                ...
                                Forms\Components\TextInput::make('min_score')
                                    ...
                                    ->minValue(0)
                                    ->maxValue(1)
                                    ->helperText(__('translations.recommendation_config_min_score_help')),
                                
                                Forms\Components\TextInput::make('cache_ttl')
                                    ->label(__('translations.recommendation_config_cache_ttl'))
                                    ->numeric()
                                    ->default(3600)
                                    ->minValue(60)
                                    ->maxValue(86400)
                                    ->helperText(__('translations.recommendation_config_cache_ttl_help')),
                            ]),
                    ]),

                Forms\Components\Section::make(__('translations.recommendation_config_advanced'))
                    ->schema([
                        Forms\Components\Tabs::make('advanced_tabs')
                            ->tabs([
                                Forms\Components\Tabs\Tab::make(__('translations.recommendation_config_performance'))
                                    ->schema([
                                        Forms\Components\Grid::make(2)
                                            ->schema([
                                                Forms\Components\Toggle::make('enable_caching')
                                                    ->label(__('translations.recommendation_config_enable_caching'))
                                                    ->default(true)
                                                    ->helperText(__('translations.recommendation_config_enable_caching_help')),
                                                
                                                Forms\Components\Toggle::make('enable_analytics')
                                                    ->label(__('translations.recommendation_config_enable_analytics'))
                                                    ->default(true)
                                                    ->helperText(__('translations.recommendation_config_enable_analytics_help')),
                                            ]),
                                        
                                        Forms\Components\Grid::make(2)
                                            ->schema([
                                                Forms\Components\TextInput::make('batch_size')
                                                    ->label(__('translations.recommendation_config_batch_size'))
                                                    ->numeric()
                                                    ->default(100)
                                                    ->minValue(10)
                                                    ->maxValue(1000)
                                                    ->helperText(__('translations.recommendation_config_batch_size_help')),
                                                
                                                Forms\Components\TextInput::make('timeout_seconds')
                                                    ->label(__('translations.recommendation_config_timeout_seconds'))
                                                    ->numeric()
                                                    ->default(30)
                                                    ->minValue(5)
                                                    ->maxValue(300)
                                                    ->helperText(__('translations.recommendation_config_timeout_seconds_help')),
                                            ]),
                                    ]),
                                
                                Forms\Components\Tabs\Tab::make(__('translations.recommendation_config_conditions'))
                                    ->schema([
                                        Forms\Components\KeyValue::make('conditions')
                                            ->label(__('translations.recommendation_config_conditions'))
                                            ->keyLabel(__('translations.condition_type'))
                                            ->valueLabel(__('translations.condition_value'))
                                            ->addActionLabel(__('translations.add_condition'))
                                            ->helperText(__('translations.recommendation_config_conditions_help')),
                                    ]),
                                
                                Forms\Components\Tabs\Tab::make(__('translations.recommendation_config_metadata'))
                                    ->schema([
                                        Forms\Components\RichEditor::make('notes')
                                            ->label(__('translations.recommendation_config_notes'))
                                            ->maxLength(2000)
                                            ->helperText(__('translations.recommendation_config_notes_help')),
                                        
                                        Forms\Components\KeyValue::make('metadata')
                                            ->label(__('translations.recommendation_config_metadata'))
                                            ->keyLabel(__('translations.metadata_key'))
                                            ->valueLabel(__('translations.metadata_value'))
                                            ->addActionLabel(__('translations.add_metadata'))
                                            ->helperText(__('translations.recommendation_config_metadata_help')),
                                    ]),
                            ]),
                    ]),
            ]);
            ...
            ->actions([
                ...
                EditAction::make(),
                    Action::make('duplicate')
                        ...
                        ->color('info')
                        ->action(function (RecommendationConfig $record) {
                    ...
                    Action::make('test')
                        ->label(__('translations.test_configuration'))
                        ->icon('heroicon-o-play')
                        ->color('success')
                        ->action(function (RecommendationConfig $record) {
                            // Test the configuration
                            Notification::make()
                                ->title(__('translations.testing_configuration'))
                                ->body(__('translations.test_completed_successfully'))
                                ->success()
                                ->send();
                        }),
                    Action::make('toggle_status')
                        ->label(fn (RecommendationConfig $record): string => $record->is_active 
                            ? __('translations.deactivate') 
                            : __('translations.activate'))
                        ->icon(fn (RecommendationConfig $record): string => $record->is_active 
                            ? 'heroicon-o-pause' 
                            : 'heroicon-o-play')
                        ->color(fn (RecommendationConfig $record): string => $record->is_active 
                            ? 'warning' 
                            : 'success')
                        ->action(function (RecommendationConfig $record) {
                            ...
                            Notification::make()
                                ->title($record->is_active 
                                    ? __('translations.activated_successfully') 
                                    : __('translations.deactivated_successfully'))
                                ->success()
                                ->send();
                        }),
                DeleteAction::make(),
                ])
                ->label(__('translations.actions'))
                ...
                BulkActionGroup::make([
                    Action::make('activate_selected')
                        ...
                        ->action(function (Collection $records) {
                            ...
                            Notification::make()
                                ->title(__('translations.bulk_activated_successfully'))
                                ->success()
                                ->send();
                        }),
                    Action::make('deactivate_selected')
                        ...
                        ->action(function (Collection $records) {
                            ...
                            Notification::make()
                                ->title(__('translations.bulk_deactivated_successfully'))
                                ->success()
                                ->send();
                        }),
