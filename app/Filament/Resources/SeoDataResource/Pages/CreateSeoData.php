 ...
 * CreateSeoData
 * 
 * Filament v4 resource for CreateSeoData management in the admin panel with comprehensive CRUD operations, filters, and actions.
 * 
...
final class CreateSeoData extends CreateRecord
{
    ...
    {
        return __('admin.seo_data.notifications.created');
    }
}