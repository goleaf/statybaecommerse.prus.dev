...
class OrderItemsRelationManager extends RelationManager
{
    ...
    {
        return $schema->schema([Section::make('orders.item_information')->schema([Grid::make(2)->schema([Select::make('product_id')->label('orders.product')->relationship('product', 'name')->searchable()->preload()->required()->reactive()->afterStateUpdated(function ($state, callable $set) {
            if ($state) {
