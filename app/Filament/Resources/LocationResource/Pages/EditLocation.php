 ...
 * EditLocation
 * 
 * Filament v4 resource for EditLocation management in the admin panel with comprehensive CRUD operations, filters, and actions.
 * 
...
final class EditLocation extends EditRecord
{
    ...
    {
        return __('locations.updated_successfully');
    }
}