...
{
    use HasWidgetTabs; // Enable contextual tab filtering for the campaign views listing.

    protected static string $resource = CampaignViewResource::class;

    /**
     * Configure widget tabs that summarise key campaign view metrics for quick navigation.
     *
