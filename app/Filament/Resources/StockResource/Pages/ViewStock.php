...
class ViewStock extends ViewRecord
{
    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            Actions\EditAction::make()
                ->label(__('inventory.edit_stock_item')),
            ...
            Actions\Action::make('reserve_stock')
            ...
            Actions\Action::make('unreserve_stock')
    ...
    {
        return [
            StockResource\Widgets\StockDetailsWidget::class,
            StockResource\Widgets\StockMovementsWidget::class,
        ];
    }
}
