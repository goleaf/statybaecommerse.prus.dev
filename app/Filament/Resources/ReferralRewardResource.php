                ...
                Forms\Components\Section::make(__('referrals.forms.reward_information'))
                    ->components([
                        Forms\Components\Select::make('referral_id')
                            ->label(__('referrals.forms.referral'))
                            ->relationship('referral', 'referral_code')
                            ->searchable()
                            ->preload()
                            ->required(),
                        Forms\Components\Select::make('user_id')
                            ->label(__('referrals.forms.user'))
                            ->relationship('user', 'name')
                            ->searchable()
                            ->preload()
                            ->required(),
                        Forms\Components\Select::make('order_id')
                            ->label(__('referrals.forms.order'))
                        ...
                        Forms\Components\TextInput::make('title')
                            ->label(__('referrals.forms.title'))
                            ->required()
                            ->maxLength(255)
                            ->translatable(),
                        Forms\Components\Textarea::make('description')
                            ->label(__('referrals.forms.description'))
                            ->nullable()
                            ->translatable()
                            ->rows(3),
                        Forms\Components\TextInput::make('amount')
                            ->label(__('referrals.forms.amount'))
                            ->numeric()
                            ->required()
                            ->prefix('€'),
                        Forms\Components\TextInput::make('currency_code')
                            ->label(__('referrals.forms.currency'))
                            ->default('EUR')
                            ->required()
                            ->maxLength(3),
                        ...
                        Forms\Components\Toggle::make('is_active')
                            ->label(__('referrals.forms.active'))
                            ->default(true),
                        Forms\Components\TextInput::make('priority')
                            ->label(__('referrals.forms.priority'))
                            ->numeric()
                            ->default(0)
                            ->minValue(0)
                            ->maxValue(100),
                    ...
                    ->columns(2),
                Forms\Components\Section::make(__('referrals.forms.conditions'))
                    ->components([
                        Forms\Components\Repeater::make('conditions')
                            ->label(__('referrals.forms.conditions'))
                            ->schema([
                                Forms\Components\TextInput::make('field')
                                    ->label(__('referrals.forms.condition_field'))
                                    ->required(),
                                Forms\Components\Select::make('operator')
                                    ->label(__('referrals.forms.condition_operator'))
                                    ->options([
                                        '=' => 'Equals',
                                        '!=' => 'Not Equals',
                                        '>' => 'Greater Than',
                                ...
                                Forms\Components\TextInput::make('value')
                                    ->label(__('referrals.forms.condition_value'))
                                    ->required(),
                            ])
                            ->columns(3)
                            ->nullable(),
                    ...
                    ->collapsible(),
                Forms\Components\Section::make(__('referrals.forms.metadata'))
                    ->components([
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('referral.referral_code')
                    ->label(__('referrals.forms.referral_code'))
                    ->searchable()
                    ->sortable(),
                ...
                Tables\Columns\TextColumn::make('created_at')
                    ->label(__('referrals.forms.created_at'))
                    ->dateTime()
                    ->sortable()
            ...
            ->filters([
                ...
                SelectFilter::make('is_active')
                    ->label(__('referrals.forms.active'))
                    ->options([
                        '1' => __('referrals.filters.active'),
                        '0' => __('referrals.filters.inactive'),
                    ]),
                Filter::make('pending')
            ...
            ->bulkActions([
                Tables\Actions\BulkActionGroup::make([
                    Tables\Actions\BulkAction::make('apply_selected')
                        ->label(__('referrals.actions.apply_selected'))
                        ->icon('heroicon-o-check-circle')
                        ->color('success')
                        ->requiresConfirmation()
                    ...
                    Tables\Actions\BulkAction::make('expire_selected')
                        ->label(__('referrals.actions.expire_selected'))
                        ->icon('heroicon-o-x-circle')
                        ->color('danger')
                        ->requiresConfirmation()
                        ->action(function (Collection $records): void {
                ...
                Infolists\Components\Section::make(__('referrals.forms.reward_details'))
                    ->components([
                        ...
                        Infolists\Components\TextEntry::make('description')
                            ->label(__('referrals.forms.description'))
                            ->translatable()
                            ->placeholder(__('referrals.forms.no_description')),
                        Infolists\Components\TextEntry::make('user.name')
                            ->label(__('referrals.forms.user')),
                        Infolists\Components\TextEntry::make('referral.referral_code')
                            ->label(__('referrals.forms.referral_code')),
                        ...
                        Infolists\Components\TextEntry::make('applied_at')
                            ->label(__('referrals.forms.applied_at'))
                            ->dateTime()
                            ->placeholder(__('referrals.forms.not_applied')),
                        Infolists\Components\TextEntry::make('expires_at')
                            ->label(__('referrals.forms.expires_at'))
                            ->dateTime()
                            ->placeholder(__('referrals.forms.never_expires')),
                    ])
                    ->columns(2),
                Infolists\Components\Section::make(__('referrals.forms.conditions'))
                    ->components([
                    ...
                    ->collapsible(),
                Infolists\Components\Section::make(__('referrals.forms.metadata'))
                    ->components([
