 ...
 */
class DiscountConditionResource extends Resource
{
                        ...
                        Forms\Components\Select::make('discount_id')
                            ...
                            ->createOptionForm([
                                ...
                                Forms\Components\Select::make('type')
                                    ->options([
                                        'percentage' => __('discounts.types.percentage'),
                                        'fixed' => __('discounts.types.fixed'),
                                        'free_shipping' => __('discounts.types.free_shipping'),
                                    ])
                                    ->required(),
                            ]),
                        Forms\Components\Select::make('type')
                ...
                Forms\Components\Section::make(__('discount_conditions.sections.translations'))
                    ->schema([
                        Forms\Components\Repeater::make('translations')
                            ->label(__('discount_conditions.fields.translations'))
                            ->relationship('translations')
                            ->schema([
                                Forms\Components\Select::make('locale')
                                    ->label(__('discount_conditions.fields.locale'))
                                    ->options([
                                        'lt' => __('common.locales.lt'),
                                ...
                                Forms\Components\KeyValue::make('metadata')
                                    ...
                                    ->valueLabel(__('discount_conditions.fields.metadata_value')),
                            ])
                            ->columns(2)
                            ->collapsible()
                ...
                Forms\Components\Section::make(__('discount_conditions.sections.advanced'))
                    ->schema([
                        Forms\Components\KeyValue::make('metadata')
                            ...
                            ->keyLabel(__('discount_conditions.fields.metadata_key'))
                            ->valueLabel(__('discount_conditions.fields.metadata_value'))
                            ->helperText(__('discount_conditions.helpers.metadata')),
                    ])
                    ->collapsible(),
            ]);
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('test_condition')
