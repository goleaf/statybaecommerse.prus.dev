 ...
 * CreatePriceListItem
 * 
 * Filament v4 resource for CreatePriceListItem management in the admin panel with comprehensive CRUD operations, filters, and actions.
 * 
...
final class CreatePriceListItem extends CreateRecord
{
    ...
    {
        return __('admin.price_list_items.notifications.created');
    }
}