 ...
 * ViewCountry
 * 
 * Filament v4 resource for ViewCountry management in the admin panel with comprehensive CRUD operations, filters, and actions.
 * 
...
final class ViewCountry extends ViewRecord
{
    ...
    {
        return [CountryDetailsWidget::class];
    }
}