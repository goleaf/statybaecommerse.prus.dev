...
final class SeoDataResource extends Resource
{
                ...
                Tabs::make('SEO Data')
                    ->tabs([
                        Tab::make(__('admin.seo_data.fields.basic_information'))
                            ...
                            ->schema([
                                Section::make(__('admin.seo_data.fields.basic_information'))
                                    ->schema([
                                        Grid::make(2)
                                            ->schema([
                                                ...
                                                Select::make('locale')
                                                    ...
                                                    ->options([
                                                        'lt' => __('admin.seo_data.fields.locale_name'),
                                                        'en' => 'English',
                                                    ])
                                                    ->required()
                                                    ->default('lt')
                                                ...
                                                TextInput::make('canonical_url')
                                                    ...
                                                    ->url()
                                                    ->maxLength(255)
                                                    ->helperText(__('admin.seo_data.help.canonical_url')),
                                            ]),
                                    ])
                                    ->columns(1),
                            ]),
                        ...
                        Tab::make(__('admin.seo_data.fields.title'))
                            ...
                            ->schema([
                                Section::make(__('admin.seo_data.fields.title'))
                                    ->schema([
                                        ...
                                        Textarea::make('keywords')
                                            ...
                                            ->maxLength(255)
                                            ->rows(2)
                                            ->helperText(__('admin.seo_data.help.keywords'))
                                            ->live()
                                            ->afterStateUpdated(function (callable $set, $state) {
                        ...
                        Tab::make(__('admin.seo_data.fields.meta_tags'))
                            ->icon('heroicon-o-tag')
                            ->schema([
                                Section::make(__('admin.seo_data.fields.meta_tags'))
                                    ->schema([
                                        KeyValue::make('meta_tags')
                                            ->label(__('admin.seo_data.fields.meta_tags'))
                                            ->keyLabel(__('admin.seo_data.meta_tags.name'))
                                            ->valueLabel(__('admin.seo_data.meta_tags.value'))
                                            ->helperText(__('admin.seo_data.help.meta_tags'))
                                        ...
                                        Repeater::make('meta_tags_structured')
                                            ...
                                            ->schema([
                                                Select::make('type')
                                                    ->label(__('admin.seo_data.meta_tags.type'))
                                                    ->options([
                                                        'og:title' => __('admin.seo_data.meta_tags.og_title'),
                                                        'og:description' => __('admin.seo_data.meta_tags.og_description'),
                                                        'og:image' => __('admin.seo_data.meta_tags.og_image'),
                                                        'og:type' => __('admin.seo_data.meta_tags.og_type'),
                                                        'og:url' => __('admin.seo_data.meta_tags.og_url'),
                                                        'twitter:card' => __('admin.seo_data.meta_tags.twitter_card'),
                                                        'twitter:title' => __('admin.seo_data.meta_tags.twitter_title'),
                                                        'twitter:description' => __('admin.seo_data.meta_tags.twitter_description'),
                                                        'twitter:image' => __('admin.seo_data.meta_tags.twitter_image'),
                                                        'author' => __('admin.seo_data.meta_tags.author'),
                                                        'publisher' => __('admin.seo_data.meta_tags.publisher'),
                                                        'copyright' => __('admin.seo_data.meta_tags.copyright'),
                                                        'language' => __('admin.seo_data.meta_tags.language'),
                                                        'geo:region' => __('admin.seo_data.meta_tags.geo_region'),
                                                        'geo:placename' => __('admin.seo_data.meta_tags.geo_placename'),
                                                        'geo:position' => __('admin.seo_data.meta_tags.geo_position'),
                                                        'ICBM' => __('admin.seo_data.meta_tags.icbm'),
                                                        'revisit-after' => __('admin.seo_data.meta_tags.revisit_after'),
                                                        'distribution' => __('admin.seo_data.meta_tags.distribution'),
                                                        'rating' => __('admin.seo_data.meta_tags.rating'),
                                                        'expires' => __('admin.seo_data.meta_tags.expires'),
                                                    ])
                                                    ->required()
                                                    ->searchable(),
                        ...
                        Tab::make(__('admin.seo_data.fields.structured_data'))
                            ...
                            ->schema([
                                Section::make(__('admin.seo_data.fields.structured_data'))
                                    ->schema([
                                        Select::make('structured_data_type')
                                            ->label(__('admin.seo_data.structured_data.type'))
                                            ->options([
                                                'Product' => __('admin.seo_data.structured_data.product'),
                                                'Article' => __('admin.seo_data.structured_data.article'),
                                                'Organization' => __('admin.seo_data.structured_data.organization'),
                                                'WebPage' => __('admin.seo_data.structured_data.website'),
                                                'BreadcrumbList' => __('admin.seo_data.structured_data.breadcrumb'),
                                                'FAQPage' => __('admin.seo_data.structured_data.faq'),
                                                'Review' => __('admin.seo_data.structured_data.review'),
                                                'Event' => __('admin.seo_data.structured_data.event'),
                                                'Recipe' => __('admin.seo_data.structured_data.recipe'),
                                                'VideoObject' => __('admin.seo_data.structured_data.video'),
                                            ])
                                            ->reactive()
                                            ->searchable(),
                                        ...
                                        KeyValue::make('structured_data')
                                            ...
                                            ->valueLabel(__('admin.seo_data.structured_data.value'))
                                            ->helperText(__('admin.seo_data.help.structured_data'))
                                            ->addActionLabel(__('admin.actions.add'))
                                            ->deleteActionLabel(__('admin.actions.delete'))
                                            ->reorderable(false),
                        ...
                        Tab::make(__('admin.seo_data.fields.robots'))
                            ...
                            ->schema([
                                Section::make(__('admin.seo_data.fields.robots'))
                                    ->schema([
                                        Grid::make(2)
                                            ->schema([
                        ...
                        Tab::make(__('admin.seo_data.fields.analysis'))
                            ...
                            ->schema([
                                Section::make(__('admin.seo_data.seo_analysis.title'))
                                    ->schema([
        ...
        return $table
            ...
            ->filters([
                SelectFilter::make('locale')
                    ->label(__('admin.seo_data.filters.locale'))
                    ->options([
                        'lt' => 'Lietuvių',
                        'en' => 'English',
                    ])
                ...
                Filter::make('seo_score_range')
                    ...
                    ->form([
                        Forms\Components\TextInput::make('seo_score_from')
                            ->label(__('admin.seo_data.filters.seo_score_from'))
                            ->numeric()
                            ->minValue(0)
                            ->maxValue(100),
                        Forms\Components\TextInput::make('seo_score_to')
                            ->label(__('admin.seo_data.filters.seo_score_to'))
                            ->numeric()
                            ->minValue(0)
                            ->maxValue(100),
                    ])
    ...
    public static function getWidgets(): array
    {
        return [
            ...
            Widgets\SeoScoreDistributionWidget::class,
            Widgets\SeoDataByTypeWidget::class,
