...
class CampaignClickStatsWidget extends BaseWidget
{
    protected function getStats(): array
    {
        ...
        return [
            Stat::make(__('campaign_clicks.total_clicks'), $totalClicks)
                ->description(__('campaign_clicks.all_time'))
            ...
            Stat::make(__('campaign_clicks.today_clicks'), $todayClicks)
                ->description(__('campaign_clicks.today'))
                ->descriptionIcon('heroicon-m-calendar-days')
                ->color('info'),

            Stat::make(__('campaign_clicks.this_week_clicks'), $thisWeekClicks)
                ->description(__('campaign_clicks.this_week'))
