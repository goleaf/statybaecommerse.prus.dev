 ...
 * RecentNewsWidget
 * 
 * Filament v4 widget for RecentNewsWidget dashboard display with real-time data and interactive features.
 * 
 * @property int|string|array $columnSpan
 * @property string|null $heading
 */
final class RecentNewsWidget extends BaseWidget
{
