...
/**
 * SystemSettingsByGroupWidget
 * 
 * Filament v4 widget for SystemSettingsByGroupWidget dashboard display with real-time data and interactive features.
 * 
...
final class SystemSettingsByGroupWidget extends ChartWidget
{
    ...
    {
        return ['responsive' => true, 'maintainAspectRatio' => false, 'plugins' => ['legend' => ['position' => 'right'], 'tooltip' => ['callbacks' => ['label' => 'function(context) {
