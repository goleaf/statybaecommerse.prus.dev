 ...
 * 
 * Filament v4 widget for LegalTypeChartWidget dashboard display with real-time data and interactive features.
 * 
...
class LegalTypeChartWidget extends ChartWidget
{
    ...
    {
        $data = Legal::select('type', DB::raw('count(*) as count'))->groupBy('type')->get()->pluck('count', 'type')->toArray();
        ...
        return ['datasets' => [['label' => __('admin.legal.documents_count'), 'data' => $values, 'backgroundColor' => [
            '#ef4444',
            // red
            '#f97316',
            // orange
