...
final class VariantStockWidget extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        $availableStock = ProductVariant::sum('available_quantity');
        $reservedStock = ProductVariant::sum('reserved_quantity');
        $soldStock = ProductVariant::sum('sold_quantity');
        ...
        $stockValue = ProductVariant::sum(DB::raw('available_quantity * cost_price'));
