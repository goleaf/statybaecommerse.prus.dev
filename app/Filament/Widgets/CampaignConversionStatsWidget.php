...
class CampaignConversionStatsWidget extends BaseWidget
{
    protected function getStats(): array
    {
        ...
        return [
            Stat::make(__('campaign_conversions.widgets.total_conversions'), $totalConversions)
            ...
            Stat::make(__('campaign_conversions.widgets.recent_conversions'), $recentConversions)
