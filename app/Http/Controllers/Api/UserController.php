...
class UserController extends Controller
{
    ...
    public function updateProfile(Request $request): UserResource
    {
        ...
        $validated = $request->validate([
            ...
            'preferred_locale' => 'sometimes|string|in:lt,en,ru,de',
            ...
            'marketing_preferences' => 'sometimes|nullable|array',
        ]);
    ...
    public function statistics(Request $request): JsonResponse
    {
        ...
        $stats = [
            ...
            'users_by_locale' => User::selectRaw('preferred_locale, count(*) as count')
                ->groupBy('preferred_locale')
                ->pluck('count', 'preferred_locale'),
