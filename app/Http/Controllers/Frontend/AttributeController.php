...
final class AttributeController extends Controller
{
    ...
    /**
     * Handle getAttributeValues functionality with proper error handling.
     * @param Request $request
     */
    ...
    /**
     * Handle getAttributeStatistics functionality with proper error handling.
     * @param Request $request
     */
    ...
    /**
     * Handle getAttributeGroups functionality with proper error handling.
     * @param Request $request
     */
    ...
    /**
     * Handle getAttributeTypes functionality with proper error handling.
     * @param Request $request
     */
