...
class OrderController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            $order = Order::create([
                ...
                'shipping_amount' => 0, // Calculate based on shipping rules
                'discount_amount' => 0,
                'total' => $subtotal,
                'currency' => 'EUR',
            ...
            return redirect()->route('frontend.orders.show', $order)
                ->with('success', __('orders.messages.created_successfully'));
    ...
    public function update(Request $request, Order $order): RedirectResponse
    {
        ...
        try {
            ...
            return redirect()->route('frontend.orders.show', $order)
                ->with('success', __('orders.messages.updated_successfully'));
    ...
    public function destroy(Order $order): RedirectResponse
    {
        ...
        return redirect()->route('frontend.orders.index')
            ->with('success', __('orders.messages.deleted_successfully'));
    }
