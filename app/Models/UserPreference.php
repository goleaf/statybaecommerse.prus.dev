...
final class UserPreference extends Model
{
    ...
    /**
     * Allow alphabetical ordering of preferences by their key identifier.
     */
    use OrdersByName;

    /**
     * Direct the shared trait to order by the preference_key column instead of the default name field.
     */
