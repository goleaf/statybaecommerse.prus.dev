...
final class Category extends Model implements HasMedia
{
    ...
    protected $fillable = ['name', 'slug', 'description', 'short_description', 'parent_id', 'sort_order', 'is_visible', 'is_enabled', 'is_featured', 'seo_title', 'seo_description', 'show_in_menu', 'product_limit'];
    protected $casts = ['name' => 'array', 'slug' => 'array', 'description' => 'array', 'short_description' => 'array', 'seo_title' => 'array', 'seo_description' => 'array', 'is_visible' => 'boolean', 'is_enabled' => 'boolean', 'is_featured' => 'boolean', 'show_in_menu' => 'boolean', 'sort_order' => 'integer', 'product_limit' => 'integer'];
    ...
    {
        return localized_route('categories.show', $this->slug);
    }
    ...
    {
        return localized_route('categories.show', $this);
    }
