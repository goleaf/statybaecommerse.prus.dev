...
final class VariantCombination extends Model
{
    ...
    /**
     * Sort variant combinations by their generated hash so deterministic names
     * flow through the shared OrdersByName trait.
     */
    protected string $nameColumn = 'combination_hash';
