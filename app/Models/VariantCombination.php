...
final class VariantCombination extends Model
{
    ...
    use OrdersByName; // Allow consumers to share the sanitised orderedByName scope when listing combinations.
    use SoftDeletes;

    /**
     * Order variant combinations by their deterministic hash to keep results stable.
     */
