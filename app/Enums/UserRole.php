...
enum UserRole: string
{
        ...
        return collect(self::cases())
            ...
            ->mapWithKeys(fn($case) => [
                $case->value => [
                    ...
                    'is_admin' => $case->isAdmin(),
                    'is_staff' => $case->isStaff(),
                    'is_customer' => $case->isCustomer(),
                    'can_access_admin' => $case->canAccessAdmin(),
                    'can_manage_users' => $case->canManageUsers(),
                    'can_manage_products' => $case->canManageProducts(),
                    'can_manage_orders' => $case->canManageOrders(),
                    'can_manage_settings' => $case->canManageSettings(),
                    'can_view_analytics' => $case->canViewAnalytics(),
                    'can_manage_content' => $case->canManageContent(),
                    'can_manage_inventory' => $case->canManageInventory(),
                    'can_manage_marketing' => $case->canManageMarketing(),
    ...
    public function toArray(): array
    {
        return [
            ...
            'can_manage_marketing' => $this->canManageMarketing(),
