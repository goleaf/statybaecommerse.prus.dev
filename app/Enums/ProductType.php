...
enum ProductType: string implements EnumInterface, HasLabel
{
    ...
    {
        return self::collection()->map(fn ($c) => $c->label())->toArray();
    }

    public static function options(): array
    {
        return self::collection()->mapWithKeys(fn ($c) => [$c->value => $c->label()])->toArray();
    }
    ...
    {
        return self::collection()->first(fn ($c) => $c->label() === $label);
    }
