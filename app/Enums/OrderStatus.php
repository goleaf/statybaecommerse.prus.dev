...
enum OrderStatus: string
{
    ...
    case COMPLETED = 'completed'; // Added to mirror the expanded enum list and seeded data.
    ...
    public function getColor(): string
    {
        return match ($this) {
            ...
            self::COMPLETED  => 'success', // Completed should share the success highlighting used for delivered orders.
    ...
    public function getIcon(): string
    {
        return match ($this) {
            ...
            self::COMPLETED  => 'heroicon-o-flag', // Use a celebratory icon to distinguish completed orders.
