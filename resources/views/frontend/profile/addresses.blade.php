<x-layouts.base title="{{ __('frontend.account.addresses.manage_title') }}">
    <div class="max-w-5xl mx-auto px-4 py-10 space-y-8">
        <h1 class="text-3xl font-semibold text-gray-900 dark:text-gray-100">{{ __('frontend.account.addresses.title') }}</h1>
        ...
        <section class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-white/10 rounded-xl shadow-sm p-6">
            ...
            <form method="POST" action="{{ route('frontend.profile.store-address') }}" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                @csrf
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300" for="type">{{ __('frontend.account.addresses.fields.type') }}</label>
                ...
                <div></div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300" for="first_name">{{ __('frontend.account.addresses.fields.first_name') }}</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300" for="last_name">{{ __('frontend.account.addresses.fields.last_name') }}</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300" for="address_line_1">{{ __('frontend.account.addresses.fields.address_line_1') }}</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300" for="address_line_2">{{ __('frontend.account.addresses.fields.address_line_2') }}</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300" for="city">{{ __('frontend.account.addresses.fields.city') }}</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300" for="postal_code">{{ __('frontend.account.addresses.fields.postal_code') }}</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300" for="country_code">{{ __('frontend.account.addresses.fields.country_code') }}</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300" for="phone">{{ __('frontend.account.addresses.fields.phone') }}</label>
                ...
                <div class="md:col-span-2 flex justify-end">
                    <button type="submit" class="inline-flex items-center px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700">{{ __('frontend.account.addresses.save') }}</button>
                </div>
            </form>
        </section>

        <section class="space-y-4">
            <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100">{{ __('frontend.account.addresses.saved') }}</h2>
            @forelse ($addresses as $address)
                <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-white/10 rounded-xl shadow-sm p-6">
                    <form method="POST" action="{{ route('frontend.profile.update-address', $address) }}" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        @method('PUT')
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300" for="type-{{ $address->id }}">{{ __('frontend.account.addresses.fields.type') }}</label>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <label for="default-{{ $address->id }}" class="text-sm text-gray-600 dark:text-gray-300">{{ __('frontend.account.addresses.default') }}</label>
                        </div>
                        <div>
                        ...
                        <div>
                            <label class="block text-sm font-medium" for="last-name-{{ $address->id }}">{{ __('frontend.account.addresses.fields.last_name') }}</label>
                        ...
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium" for="line1-{{ $address->id }}">{{ __('frontend.account.addresses.fields.address_line_1') }}</label>
                        ...
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium" for="line2-{{ $address->id }}">{{ __('frontend.account.addresses.fields.address_line_2') }}</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium" for="city-{{ $address->id }}">{{ __('frontend.account.addresses.fields.city') }}</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium" for="postal-{{ $address->id }}">{{ __('frontend.account.addresses.fields.postal_code') }}</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium" for="country-{{ $address->id }}">{{ __('frontend.account.addresses.fields.country_code') }}</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium" for="phone-{{ $address->id }}">{{ __('frontend.account.addresses.fields.phone') }}</label>
                        ...
                        <div class="md:col-span-2 flex justify-end gap-3">
                            <button type="submit" class="inline-flex items-center px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700">{{ __('frontend.account.addresses.update') }}</button>
                        </div>
                    </form>
                    <form method="POST" action="{{ route('frontend.profile.delete-address', $address) }}" class="mt-2">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="text-sm text-red-600 hover:text-red-700">{{ __('frontend.account.addresses.delete') }}</button>
                    </form>
                </div>
            @empty
                <p class="text-gray-500 dark:text-gray-400">{{ __('frontend.account.addresses.empty') }}</p>
            @endforelse
        </section>
    </div>
</x-layouts.base>
