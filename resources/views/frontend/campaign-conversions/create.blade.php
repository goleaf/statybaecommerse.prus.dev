...
@section('title', __('campaign_conversions.pages.create.title'))
@section('description', __('campaign_conversions.pages.create.description'))

@section('content')
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">{{ __('campaign_conversions.pages.create.title') }}</h1>
            <p class="text-gray-600 mt-2">{{ __('campaign_conversions.pages.create.description') }}</p>
        </div>
        <div>
    ...
    <div class="max-w-4xl mx-auto">
        <form method="POST" action="{{ route('frontend.campaign-conversions.store') }}" class="space-y-8">
            @csrf

            <!-- Basic Information -->
            <div class="bg-white rounded-lg shadow-md p-6">
                <h2 class="text-xl font-semibold text-gray-900 mb-6">{{ __('campaign_conversions.sections.basic_information') }}</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="conversion_type" id="conversion_type" required 
                            ...
                            @foreach($conversionTypes as $key => $label)
                                <option value="{{ $key }}" {{ old('conversion_type') == $key ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        <label for="conversion_value" class="block text-sm font-medium text-gray-700 mb-2">
                            {{ __('campaign_conversions.fields.conversion_value') }} <span class="text-red-500">*</span>
                        </label>
                        <div class="relative">
                            ...
                            <input type="number" name="conversion_value" id="conversion_value" required 
                                   value="{{ old('conversion_value') }}" step="0.01" min="0"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="datetime-local" name="converted_at" id="converted_at" required 
                               value="{{ old('converted_at', now()->format('Y-m-d\TH:i')) }}"
                               class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        @error('converted_at')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <h2 class="text-xl font-semibold text-gray-900 mb-6">{{ __('campaign_conversions.sections.tracking_information') }}</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="medium" id="medium" 
                               value="{{ old('medium') }}" maxlength="255"
                               class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        @error('medium')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" name="campaign_name" id="campaign_name" 
                               value="{{ old('campaign_name') }}" maxlength="255"
                               class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        @error('campaign_name')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" name="utm_content" id="utm_content" 
                               value="{{ old('utm_content') }}" maxlength="255"
                               class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        @error('utm_content')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" name="utm_term" id="utm_term" 
                               value="{{ old('utm_term') }}" maxlength="255"
                               class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        @error('utm_term')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="url" name="referrer" id="referrer" 
                               value="{{ old('referrer') }}" maxlength="500"
                               class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        @error('referrer')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
            ...
            <!-- Device Information -->
            <div class="bg-white rounded-lg shadow-md p-6">
                <h2 class="text-xl font-semibold text-gray-900 mb-6">{{ __('campaign_conversions.sections.device_information') }}</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="browser" id="browser" 
                               value="{{ old('browser') }}" maxlength="255"
                               class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        @error('browser')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <h2 class="text-xl font-semibold text-gray-900 mb-6">{{ __('campaign_conversions.sections.additional_information') }}</h2>
