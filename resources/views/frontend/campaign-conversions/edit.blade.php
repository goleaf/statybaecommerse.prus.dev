...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="max-w-4xl mx-auto">
        <form method="POST" action="{{ route('frontend.campaign-conversions.update', $campaignConversion) }}" class="space-y-8">
            @csrf
            @method('PUT')
                    ...
                    <div>
                        ...
                        <select name="campaign_id" id="campaign_id" required 
                            ...
                            @foreach($campaigns as $campaign)
                                <option value="{{ $campaign->id }}" {{ old('campaign_id', $campaignConversion->campaign_id) == $campaign->id ? 'selected' : '' }}>
                                    {{ $campaign->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="conversion_type" id="conversion_type" required 
                            ...
                            @foreach($conversionTypes as $key => $label)
                                <option value="{{ $key }}" {{ old('conversion_type', $campaignConversion->conversion_type) == $key ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="conversion_value" id="conversion_value" required 
                                   value="{{ old('conversion_value', $campaignConversion->conversion_value) }}" step="0.01" min="0"
                    ...
                    <div>
                        ...
                        <select name="status" id="status" required 
                            ...
                            @foreach($statuses as $key => $label)
                                <option value="{{ $key }}" {{ old('status', $campaignConversion->status) == $key ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="device_type" id="device_type" 
                            ...
                            @foreach($deviceTypes as $key => $label)
                                <option value="{{ $key }}" {{ old('device_type', $campaignConversion->device_type) == $key ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
