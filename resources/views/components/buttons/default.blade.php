...
@if ($href)
    <x-link
        :$href
        {{ $attributes->merge(['class' => 'group relative inline-flex py-2.5 border border-gray-300 text-sm font-medium text-gray-500 bg-white shadow-sm hover:bg-gray-50 hover:text-gray-700 focus:outline-none']) }}
    >
        <span
            @class([
