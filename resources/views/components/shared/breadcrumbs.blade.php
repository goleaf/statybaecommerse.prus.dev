...
@if(!empty($items) || $showHome)
    <nav class="flex" aria-label="{{ __('messages.frontend') }}">
        <ol class="flex items-center space-x-2 text-sm">
            @if($showHome)
                <li>
                    <a href="{{ route('home') }}" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 transition-colors duration-200">
