...
<div x-data="{ open: false }" class="lg:hidden">
    ...
    <button @click="open = !open"
            ...
            type="button"
            aria-label="{{ __('frontend.mobile_menu.toggle') }}">
    ...
    <div x-show="open"
        ...
        <div class="flex items-center justify-between p-4 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-900">{{ __('frontend.mobile_menu.title') }}</h2>
        ...
        <div class="p-4 space-y-6">
            ...
            <nav class="space-y-2">
                ...
                <a href="{{ route('localized.categories.index', ['locale' => app()->getLocale()]) }}"
                   class="flex items-center gap-3 px-3 py-2 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors duration-200">
                    ...
                    {{ __('frontend.navigation.categories') }}
                </a>
                ...
                <a href="{{ route('localized.brands.index', ['locale' => app()->getLocale()]) }}"
                   class="flex items-center gap-3 px-3 py-2 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors duration-200">
                    ...
                    {{ __('frontend.navigation.brands') }}
                </a>
            </nav>

            {{-- Categories Section --}}
            <div>
                <h3 class="text-sm font-semibold text-gray-900 mb-3">{{ __('frontend.navigation.categories') }}</h3>
                <div class="space-y-1">
            ...
            {{-- Brands Section --}}
            <div>
                <h3 class="text-sm font-semibold text-gray-900 mb-3">{{ __('frontend.mobile_menu.popular_brands') }}</h3>
