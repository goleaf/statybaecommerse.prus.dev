<div class="px-4 py-5">
    <div
        ...
        <a class="shrink-0" href="https://statybaecommerse.prus.dev/admin/dashboard" wire:navigate.hover>
            <img class="size-9" src="https://statybaecommerse.prus.dev/images/hero.png" alt="{{ config('app.name') }}">
