				...
				<div class="rounded-xl border border-white/15 bg-white/5 backdrop-blur-sm p-8 text-white">
                    ...
                    <div class="space-y-4 max-w-2xl">
                        ...
                        <div class="flex flex-wrap items-center gap-3">
                            <a href="mailto:{{ __('frontend/header.topbar.email_href') }}" class="px-6 py-3 bg-sage font-semibold transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2 relative overflow-hidden group rounded-md">
