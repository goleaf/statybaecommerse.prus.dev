        ...
        <div class="space-y-4">
            @if(empty($recommendations))
                <div class="text-center py-8">
                    ...
                    <p class="text-gray-600 dark:text-gray-400">Your sliders are optimized. No recommendations at this time.</p>
                </div>
            @else
                @foreach($recommendations as $recommendation)
                    <div class="border rounded-lg p-4 {{ match($recommendation['type']) {
                        ...
                        <div class="flex items-start gap-3">
                            <div class="flex-shrink-0">
                                <div class="w-8 h-8 rounded-full flex items-center justify-center {{ match($recommendation['type']) {
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ match($recommendation['type']) {
                                        ...
                                        {{ $recommendation['count'] }} slider{{ $recommendation['count'] !== 1 ? 's' : '' }}
                                    </span>
                                </div>
                                ...
                                <div class="mt-2">
                                    <span class="text-xs font-medium {{ match($recommendation['type']) {
