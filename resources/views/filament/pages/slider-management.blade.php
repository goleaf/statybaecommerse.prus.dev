    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('translations.total_sliders') }}</p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('translations.active_sliders') }}</p>
                        <p class="text-2xl font-semibold text-gray-900 dark:text-white">{{ $sliders->where('is_active', true)->count() }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('translations.inactive_sliders') }}</p>
                        <p class="text-2xl font-semibold text-gray-900 dark:text-white">{{ $sliders->where('is_active', false)->count() }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('translations.recent_sliders') }}</p>
                        <p class="text-2xl font-semibold text-gray-900 dark:text-white">{{ $sliders->where('created_at', '>=', now()->subWeek())->count() }}</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="p-4">
                            ...
                            <div class="space-y-2 mb-4">
                                <div class="flex items-center justify-between text-sm">
                                    <span class="text-gray-500 dark:text-gray-400">{{ __('translations.sort_order') }}:</span>
                                    <span class="font-medium">{{ $slider->sort_order }}</span>
                                </div>
                                
                                <div class="flex items-center justify-between text-sm">
                                    <span class="text-gray-500 dark:text-gray-400">{{ __('translations.animation') }}:</span>
                                    <span class="font-medium capitalize">{{ $slider->getAnimationType() }}</span>
                                </div>
                                
                                <div class="flex items-center justify-between text-sm">
                                    <span class="text-gray-500 dark:text-gray-400">{{ __('translations.duration') }}:</span>
                            ...
                            <div class="flex items-center space-x-2 mb-4">
                                <div class="flex items-center space-x-1">
                                    <div class="w-4 h-4 rounded border" style="background-color: {{ $slider->getEffectiveBackgroundColor() }}"></div>
                                    <span class="text-xs text-gray-500">{{ __('translations.background') }}</span>
                                </div>
                                <div class="flex items-center space-x-1">
                                    <div class="w-4 h-4 rounded border" style="background-color: {{ $slider->getEffectiveTextColor() }}"></div>
        ...
        @else
            ...
            <div class="text-center py-12">
                ...
                <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('translations.no_sliders') }}</h3>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('translations.no_sliders_description') }}</p>
                <div class="mt-6">
