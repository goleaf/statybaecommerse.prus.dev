            ...
            <div class="lg:col-span-2">
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">{{ __('translations.no_reviews_for_product') }}</h3>
                        <p class="mt-1 text-sm text-gray-500">{{ __('translations.be_first_to_review') }}</p>
                        <div class="mt-6">
                            @auth
