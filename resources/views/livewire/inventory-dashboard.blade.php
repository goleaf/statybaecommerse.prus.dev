    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600 dark:text-gray-400">{{ __('ui.total_products') }}</p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600 dark:text-gray-400">{{ __('messages.in_stock') }}</p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600 dark:text-gray-400">{{ __('messages.low_stock') }}</p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600 dark:text-gray-400">{{ __('messages.out_of_stock') }}</p>
    ...
    @if(!empty($lowStockProducts))
        <div class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-6">
            <div class="flex items-center">
                ...
                <h3 class="text-lg font-medium text-yellow-800 dark:text-yellow-200">{{ __('messages.low_stock_alert') }}</h3>
            </div>
            <p class="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                {{ __('ui.the_following_products_are_running_low_on_stock') }}
            </p>
    ...
    @if(!empty($outOfStockProducts))
        <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6">
            <div class="flex items-center">
                ...
                <h3 class="text-lg font-medium text-red-800 dark:text-red-200">{{ __('ui.out_of_stock_alert') }}</h3>
            </div>
            <p class="mt-2 text-sm text-red-700 dark:text-red-300">
                {{ __('ui.the_following_products_are_out_of_stock') }}
            </p>
            <div class="mt-4 space-y-2">
