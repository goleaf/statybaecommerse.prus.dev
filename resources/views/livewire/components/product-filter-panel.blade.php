<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <button
            ...
            {{ __('messages.translations) ?? 'Clear All' }}
        </button>
    </div>
    ...
    <div class="space-y-6">
        ...
        <div>
            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3 flex items-center gap-2">
                ...
                {{ __('messages.translations) ?? 'Search' }}
            </label>
            <div class="relative">
                <input
                       wire:model.live.debounce.300ms="search"
                       type="text"
                       placeholder="{{ __('messages.translations) ?? 'Search products...' }}"
        ...
        <div>
            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3 flex items-center gap-2">
                ...
                {{ __('messages.translations) ?? 'Categories' }}
            </label>
        ...
        <div>
            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3 flex items-center gap-2">
                ...
                {{ __('messages.translations) ?? 'Brands' }}
            </label>
            <div class="max-h-40 overflow-y-auto space-y-2 bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
        ...
        <div>
            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3 flex items-center gap-2">
                ...
                {{ __('messages.translations) ?? 'Price Range' }}
            </label>
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label
                               class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-2">{{ __('messages.translations) ?? 'Min Price' }}</label>
                        <div class="relative">
                            <input
                    ...
                    <div>
                        <label
                               class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-2">{{ __('messages.translations) ?? 'Max Price' }}</label>
                        <div class="relative">
                            <input
        ...
        <div class="space-y-4">
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                <h4 class="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3 flex items-center gap-2">
                    ...
                    {{ __('messages.translations) ?? 'Quick Filters' }}
                </h4>
                <div class="space-y-3">
                    <label
                           class="flex items-center p-2 rounded-lg hover:bg-white dark:hover:bg-gray-600 transition-colors duration-200 cursor-pointer">
                        ...
                        <span
                            ...
                            {{ __('messages.translations) ?? 'In Stock Only' }}
                        </span>
                    </label>
                    ...
                    <label
                        ...
                        <span
                            ...
                            {{ __('messages.translations) ?? 'On Sale Only' }}
                        </span>
                    </label>
                </div>
            </div>
        ...
        <div>
            ...
            <div class="grid grid-cols-2 gap-2">
                <select
                    ...
                    <option value="price">{{ __('messages.translations) }}</option>
                ...
                <select
                        ...
                        class="rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm">
                    <option value="asc">{{ __('messages.translations) }}</option>
                    <option value="desc">{{ __('messages.translations) }}</option>
                </select>
            </div>
        </div>
    </div>
