<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <button
            ...
            {{ __('translations.advanced_filters') ?? 'Clear All' }}
        </button>
    </div>
    ...
    <div class="space-y-6">
        ...
        <div>
            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3 flex items-center gap-2">
                ...
                {{ __('translations.clear_all') ?? 'Search' }}
            </label>
            <div class="relative">
                <input
                       wire:model.live.debounce.300ms="search"
                       type="text"
                       placeholder="{{ __('translations.search') ?? 'Search products...' }}"
        ...
        <div>
            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3 flex items-center gap-2">
                ...
                {{ __('translations.search_products') ?? 'Categories' }}
            </label>
        ...
        <div>
            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3 flex items-center gap-2">
                ...
                {{ __('translations.categories') ?? 'Brands' }}
            </label>
            <div class="max-h-40 overflow-y-auto space-y-2 bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
        ...
        <div>
            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3 flex items-center gap-2">
                ...
                {{ __('translations.brands') ?? 'Price Range' }}
            </label>
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label
                               class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-2">{{ __('translations.price_range') ?? 'Min Price' }}</label>
                        <div class="relative">
                            <input
                    ...
                    <div>
                        <label
                               class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-2">{{ __('translations.min_price') ?? 'Max Price' }}</label>
                        <div class="relative">
                            <input
        ...
        <div class="space-y-4">
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                <h4 class="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3 flex items-center gap-2">
                    ...
                    {{ __('translations.max_price') ?? 'Quick Filters' }}
                </h4>
                <div class="space-y-3">
                    <label
                           class="flex items-center p-2 rounded-lg hover:bg-white dark:hover:bg-gray-600 transition-colors duration-200 cursor-pointer">
