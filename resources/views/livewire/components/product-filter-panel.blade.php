        ...
        <div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label
                               class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-2">{{ __('translations.min_price') }}</label>
                        <div class="relative">
                            <input
                    ...
                    <div>
                        <label
                               class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-2">{{ __('translations.max_price') }}</label>
                        <div class="relative">
                            <input
