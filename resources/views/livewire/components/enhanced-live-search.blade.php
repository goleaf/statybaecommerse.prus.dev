        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <div class="flex gap-2">
                    <input wire:model.live="minPrice" type="number" placeholder="{{ __('frontend.search_results.filters.min') }}" class="flex-1 text-sm border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    <input wire:model.live="maxPrice" type="number" placeholder="{{ __('frontend.search_results.filters.max') }}" class="flex-1 text-sm border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                </div>
            </div>
            ...
            <div>
                ...
                <select wire:model.live="sortBy" class="w-full text-sm border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    ...
                    <option value="newest">{{ __('frontend.search_results.sort.newest') }}</option>
                </select>
            </div>
        </div>
        ...
        @if($isSearching)
            ...
            <div class="flex items-center justify-center py-12">
                <div class="flex flex-col items-center space-y-3 text-gray-500">
                    ...
                    <span class="text-sm font-medium">{{ __('frontend.search.search_products_label') }}</span>
