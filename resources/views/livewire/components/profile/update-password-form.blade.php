<div>
    <form wire:submit="updatePassword" class="space-y-6">
        <div>
            <x-forms.label for="current_password" :value="__('translations.current_password')" />
        ...
        <div>
            <x-forms.label for="password" :value="__('translations.new_password')" />
        ...
        <div>
            <x-forms.label for="password_confirmation" :value="__('translations.confirm_password')" />
        ...
        <div class="flex items-center gap-4">
            <button type="submit"
                    class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">{{ __('translations.save') }}</button>
