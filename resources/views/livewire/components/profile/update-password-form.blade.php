<div>
    <form wire:submit="updatePassword" class="space-y-6">
        <div>
            <x-forms.label for="current_password" :value="__('Update Password')" />
        ...
        <div>
            <x-forms.label for="password" :value="__('Ensure your account is using a long, random password to stay secure.')" />
        ...
        <div>
            <x-forms.label for="password_confirmation" :value="__('Current Password')" />
        ...
        <div class="flex items-center gap-4">
            <button type="submit"
                    class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">{{ __('New Password') }}</button>
