<div class="space-y-4">
    <div class="space-y-2">
        <label class="block text-sm font-medium text-dark">{{ __('translations.coupon_code') }}</label>
        ...
        <div class="bg-green-50 border border-green-200 rounded-xl p-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-sm font-medium text-green-800">{{ __('translations.coupon_applied') }}</span>
                </div>
                <button type="button" 
                        wire:click="remove"
