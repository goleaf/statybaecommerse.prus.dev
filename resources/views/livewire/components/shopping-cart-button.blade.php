...
<div class="relative ml-4 flow-root lg:ml-6" x-data="{ qty: 0 }" x-init="window.addEventListener('cartUpdated', e => { qty = e.detail?.quantity ?? qty })">
    <button
        ...
        <span class="ml-2 text-sm font-medium text-gray-700 group-hover:text-gray-800" x-text="qty"></span>
