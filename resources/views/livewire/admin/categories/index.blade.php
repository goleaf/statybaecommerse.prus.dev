                    ...
                    <thead class="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider cursor-pointer"
                                ...
                                {{ __('admin.categories.table.name') }}
                                @if ($sortBy === 'name')
                            ...
                            <th
                                ...
                                {{ __('admin.categories.table.description') }}
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider cursor-pointer"
                                wire:click="sortBy('created_at')">
                                {{ __('admin.categories.table.created') }}
                            ...
                            <th
                                class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                                {{ __('admin.categories.table.status') }}
                            </th>
                            <th
                                class="px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                                {{ __('admin.categories.table.actions') }}
                            </th>
                        </tr>
                    </thead>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        ...
                                        {{ $category->is_visible ? __('admin.categories.status.active') : __('admin.categories.status.inactive') }}
                                    </span>
                                </td>
