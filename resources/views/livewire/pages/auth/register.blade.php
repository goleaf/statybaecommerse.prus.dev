...
new #[Layout('components.layouts.templates.app')] class extends Component {
    ...
    public function register(): void
    {
        ...
        // Persist current locale on the user for notifications & preferences
                ...
                <form wire:submit="register">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <x-forms.input wire:model="last_name" id="last_name" class="block mt-1 w-full"
                        ...
                        <div>
                            ...
                            <x-forms.input wire:model="first_name" id="first_name" class="block mt-1 w-full"
                                           type="text" name="first_name" required autocomplete="first_name" />
