                            ...
                            <div class="flex justify-between items-center">
                                <div class="flex flex-col">
                                    ...
                                    @if ($product->stock_quantity > 0)
                                        <span class="text-xs text-green-600">{{ __('In stock') }}
        ...
        @else
            <div class="text-center py-12">
                <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24"
                     stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M9.172 16.172a4 4 0 015.656 0M9 12h6m-6-4h6m2 5.291A7.962 7.962 0 0112 15c-2.34 0-4.5-.81-6.172-2.172C5.088 12.088 5 11.544 5 11V5a2 2 0 012-2h10a2 2 0 012 2v6c0 .544-.088 1.088-.828 1.828z" />
                </svg>
