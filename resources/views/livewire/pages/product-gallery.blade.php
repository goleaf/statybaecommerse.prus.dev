        ...
        <div class="text-center mb-8">
            ...
            <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto">
                <div class="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm">
                    ...
                    <div class="text-sm text-gray-600 dark:text-gray-400">{{ __('messages.translations) }}</div>
                </div>
                <div class="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm">
                            ...
                            @if($product->hasImages())
                                ...
                                @if(count($images) > 1)
                                    <div class="absolute top-2 left-2 bg-black/60 text-white px-2 py-1 rounded text-xs">
                                        {{ count($images) }} {{ __('messages.translations) }}
                                    </div>
                                @endif
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                @if($product->hasImages())
                                    <span class="text-sm text-green-600 dark:text-green-400 font-medium">
                                        {{ $product->getImagesCount() }} {{ __('messages.translations) }}
                                    </span>
                                @endif
                            </div>
