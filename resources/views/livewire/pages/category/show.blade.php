<div x-data="{ showFilters: false, viewMode: 'grid' }" class="min-h-screen bg-gray-50 dark:bg-gray-900">
    <x-container class="py-8 lg:py-12">
        ...
        <div class="mb-8">
            <x-breadcrumbs :items="[
                ['label' => __('translations.categories'), 'url' => localized_route('categories.index')],
        ...
        <div class="mb-8">
            <div
                 class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 lg:p-8">
                <div class="flex items-start justify-between gap-6">
                    <div class="flex-1">
                        ...
                        @if (!empty($category->description))
                            <p class="text-gray-600 dark:text-gray-300 text-lg leading-relaxed max-w-3xl">
                    ...
                    <div class="flex items-center gap-4">
                        <div class="bg-blue-50 dark:bg-blue-900/20 px-4 py-2 rounded-lg">
                            <span class="text-sm font-semibold text-blue-700 dark:text-blue-300">
                                {{ __('translations.showing') ?? 'Showing' }}
                                {{ $products->firstItem() }}–{{ $products->lastItem() }}
                                {{ __('translations.of_total') ?? 'of' }} {{ $products->total() }}
                            </span>
                        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div x-cloak x-show="showFilters" class="lg:hidden fixed inset-0 z-50">
                    ...
                    <div
                        ...
                        <div class="p-4 space-y-6">
                            <div>
                                <h4
                                    class="mb-3 text-sm font-semibold text-gray-700 dark:text-gray-300 flex items-center gap-2">
            ...
            <section class="lg:col-span-9">
                ...
                <div
                     class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-lg p-4 mb-6">
                    <div class="flex items-center justify-between gap-4">
                        ...
                        <div class="flex items-center gap-3">
                            <div class="flex items-center gap-2">
                                <label
                                       class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('translations.sort_by') ?? 'Sort by' }}:</label>
                            ...
                            <div class="flex items-center gap-2">
                                <label
                                       class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('translations.order') ?? 'Order' }}:</label>
                                <select wire:model.live="sortDirection"
                                        class="rounded-lg border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-sm font-medium text-gray-900 dark:text-white px-3 py-2 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200">
                                    <option value="asc">{{ __('translations.ascending') ?? 'Ascending' }}</option>
                                    <option value="desc">{{ __('translations.descending') ?? 'Descending' }}
                                    </option>
                                </select>
                            </div>
                        </div>
                ...
                @if ($products->count() > 0)
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6"
                         :class="viewMode === 'list' ? 'grid-cols-1' :
                    ...
                    <div class="mt-12 flex justify-center">
                        <div
                             class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-lg p-4">
                ...
                @else
                    ...
                    <div
                         class="bg-white dark:bg-gray-800 rounded-2xl border border-dashed border-gray-300 dark:border-gray-700 p-12 text-center shadow-lg">
