...
<div class="bg-white py-10">
    <x-container class="grid gap-10 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
        ...
        <section class="space-y-8">
            ...
            @php($steps = [
                ['label' => __('Billing details'), 'number' => 1],
                ['label' => __('Shipping method'), 'number' => 2],
                ['label' => __('Payment & confirmation'), 'number' => 3],
            ])
            ...
            {{-- Billing step collects core invoicing information. --}}
            @if ($currentStep === 1)
            ...
            {{-- Shipping step shows delivery address fields and carrier choices. --}}
            @if ($currentStep === 2)
                <form wire:submit.prevent="nextStep" class="space-y-6">
            ...
            {{-- Final step captures payment preference and submits the order. --}}
            @if ($currentStep === 3)
