                ...
                <div class="relative h-56 w-full overflow-hidden">
                    ...
                    <div class="absolute bottom-5 left-5 right-5 space-y-2 text-white">
                        <span
                            ...
                            {{ __('messages.home_collections_badge') }}
                        </span>
                ...
                <div class="space-y-3 px-6 py-6">
                    ...
                    <div class="flex items-center justify-between text-xs font-medium text-white/70">
                        <span class="inline-flex items-center gap-1">
                            ...
                            {{ trans_choice(__('messages.home_collections_products_count'), $productsCount, ['count' => $productsCount]) }}
                        </span>
                        <span class="inline-flex items-center gap-1 text-white/80">
                            {{ __('messages.home_collections_open') }}
                            <svg class="h-3.5 w-3.5" fill="none" stroke="currentColor" stroke-width="1.5"
                                 viewBox="0 0 24 24">
