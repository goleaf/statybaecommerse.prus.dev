<section class="relative bg-gradient-to-b from-indigo-50 to-white py-20 text-gray-900"
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div aria-label="{{ __('home_collections_grid') }}">
