<section class="relative py-20 bg-gray-50 text-gray-900" aria-labelledby="home-categories-heading">
    <div
         class="absolute inset-x-0 -top-32 -bottom-20 bg-gradient-to-b from-indigo-500/5 via-transparent to-transparent pointer-events-none">
    </div>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div aria-label="{{ __('messages.categories') }}">
