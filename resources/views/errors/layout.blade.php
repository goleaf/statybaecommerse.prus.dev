                                        ...
                                        <div class="flex-1">
                                            <div class="flex items-center justify-between gap-2">
                                                ...
                                                @if(!empty($category['product_count']))
                                                    <span class="text-xs font-medium text-blue-600 bg-blue-50 px-2.5 py-1 rounded-full">{{ trans_choice('messages.frontend_collections', (int) $category['product_count'], ['count' => (int) $category['product_count']]) }}</span>
                                                @endif
                                            </div>
