...
@section('title', __('translations.request_product') . ' - ' . ($product->trans('ui.name') ?? $product->name))
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="bg-gray-50 rounded-lg p-4 mb-6">
                <div class="flex items-center space-x-4">
                    ...
                    @endif
                    <div>
                        <h3 class="font-semibold text-gray-900">{{ $product->trans('ui.name') ?? $product->name }}</h3>
