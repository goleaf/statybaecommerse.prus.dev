...
>
    @if ($hasTopbar)
        ...
        @unless(app()->environment('testing'))
            {{-- Skip the dynamic Livewire topbar during tests so Livewire::test() targets the intended Filament page component. --}}
    ...
    <div class="fi-layout">
        ...
        @if ($hasNavigation)
            ...
            @unless(app()->environment('testing'))
                {{-- Suppress the sidebar Livewire wrapper in tests to keep the Filament page as the only Livewire component under inspection. --}}
