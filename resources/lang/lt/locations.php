...
return [
    ...
    'fields' => [
        ...
        'contact_field'             => 'Kontakto laukas',
        'contact_value'             => 'Kontakto reikšmė',
        'website'                   => 'Svetainė',
        'additional_address'        => 'Papildomi adreso laukai',
        ...
        'inventories_count'         => 'Atsargų kiekis',
        'variant_inventories_count' => 'Variantų atsargos',
    ],
    ...
    'type_other'               => 'Kita',
    'type_distribution_center' => 'Distribucinis centras',
    ...
    'actions' => [
        ...
        'export_coordinates'   => 'Eksportuoti koordinates',
        'add_address_field'    => 'Pridėti adreso lauką',
        'add_contact_field'    => 'Pridėti kontakto lauką',
        'activate_selected'    => 'Aktyvuoti pasirinktus',
        'deactivate_selected'  => 'Deaktyvuoti pasirinktus',
        'set_default_selected' => 'Nustatyti pasirinktą numatytąja',
    ],
    ...
    'filters' => [
        ...
        'without_coordinates'   => 'Be koordinačių',
        'has_opening_hours'     => 'Turi darbo valandas',
        'with_opening_hours'    => 'Su darbo valandomis',
        'without_opening_hours' => 'Be darbo valandų',
    ...
    'messages' => [
        ...
        'activated'                    => 'Vieta sėkmingai aktyvuota',
        'deactivated'                  => 'Vieta sėkmingai deaktyvuota',
        'set_as_default_success'       => 'Vieta nustatyta kaip numatytoji',
        'bulk_activated_success'       => 'Pasirinktos vietos sėkmingai aktyvuotos',
        'bulk_deactivated_success'     => 'Pasirinktos vietos sėkmingai deaktyvuotos',
        'bulk_set_default_success'     => 'Pirmoji pasirinkta vieta nustatyta kaip numatytoji',
        'coordinates_copied'           => 'Koordinatės nukopijuotos',
        'coordinates_exported'         => 'Koordinatės sėkmingai eksportuotos',
        'coordinates_count'            => 'Eksportuota koordinacių: :count',
    ],
