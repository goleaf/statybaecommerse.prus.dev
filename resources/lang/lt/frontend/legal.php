...
return [
    ...
    'refund_policy_description' => 'Grąžinimo politika aprašo mūsų grąžinimo procedūras ir sąlygas.',
    'shipping_policy_description' => 'Pristatymo politika paaiškina mūsų pristatymo sąlygas, terminus ir mokesčius.',
    'cookie_policy_description' => 'Slapukų politika paaiškina, kaip naudojame slapukus ir panašias technologijas.',
    'gdpr_policy_description' => 'GDPR politika aprašo, kaip atitinkame Bendrą duomenų apsaugos reglamentą.',
    'legal_notice_description' => 'Teisinė informacija apie įmonę, jos veiklą ir teisinį statusą.',
    'imprint_description' => 'Imprint informacija apie įmonės registraciją ir kontaktus.',
];
