...
return [
    ...
    'badges' => [
        'payment'        => 'Mokėjimas: :status',
        'payment_method' => 'Būdas: :method',
        'channel'        => 'Kanalas: :channel',
        'shipping'       => [
            'pending'   => 'Siunta ruošiama',
            'shipped'   => 'Išsiųsta :date',
            'delivered' => 'Pristatyta :date',
        ],
        'total'          => 'Suma: :total',
        'items'          => '{0} Nėra prekių|{1} 1 prekė|[2,*] :count prekės',
        'status_tooltip' => 'Užsakymo :number būsenų suvestinė',
    ],
