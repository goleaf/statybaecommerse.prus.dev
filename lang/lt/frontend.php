...
return [
    ...
    'products' => 'Produktai',
    'home' => [
        'title'                        => 'Sveiki atvykę į mūsų parduotuvę',
        'hero_title'                   => 'Atraskite profesionalius įrankius kiekvienam projektui',
        'hero_description'             => 'Naršykite išskirtinius produktus, patikimus prekės ženklus ir raskite tinkamą įrangą savo darbams.',
        'shop_all_products'            => 'Pirkti visus produktus',
        'browse_categories'            => 'Naršyti kategorijas',
        'trusted_by'                   => 'Pasitiki statybininkai visoje Lietuvoje',
        'premium_message'              => 'Aukščiausios kokybės įranga, ekspertų patarimai ir greitas pristatymas į kiekvieną regioną.',
        'featured_products'            => 'Išskirtiniai produktai',
        'new_arrivals'                 => 'Naujienos',
        'featured_products_description'=> 'Mūsų komanda išskiria populiariausius ir geriausiai vertinamus produktus.',
        ...
        'featured_empty'               => 'Išskirtinių produktų dar nėra. Užsukite vėliau!',
        'latest_arrivals'              => 'Naujausi atvykimai',
        'latest_empty'                 => 'Ruošiame naujus produktus. Sugrįžkite vėliau!',
        'shop_by_category'             => 'Pirkti pagal kategoriją',
        'view_category'                => 'Peržiūrėti',
        'category_fallback'            => 'Atraskite kruopščiai atrinktus įrankius šioje kategorijoje.',
        'categories_empty'             => 'Kategorijos dar kuriamos. Patikrinkite vėliau.',
        'featured_brands'              => 'Išskirtiniai prekės ženklai',
        'brand_description_fallback'   => 'Patikimas gamintojas su kokybiškais produktais.',
        'brand_product_count'          => '{0}Produktų dar nėra|{1}1 produktas|[2,*]:count produktai',
        'brands_empty'                 => 'Prekės ženklai pasirodys, kai bus paskelbti nauji produktai.',
    ],
    'errors' => [
        'defaults' => [
            'title'       => 'Įvyko klaida',
        ...
        '4xx' => [
            'title' => 'Nepavyko įvykdyti užklausos',
            'description' => 'Šiuo metu nepavyko apdoroti jūsų užklausos. Patikrinkite adresą arba bandykite dar kartą.',
            'support_title' => 'Reikia pagalbos?',
            'support_description' => 'Jei tai kartojasi, susisiekite su pagalbos komanda ir nurodykite nuorodos ID.',
        ],
        '403' => [
            'title' => 'Prieiga uždrausta',
            'description' => 'Neturite teisės pasiekti šio puslapio. Jei manote, kad tai klaida, susisiekite su mūsų pagalbos komanda.',
            'links' => [
                'view_account' => 'Peržiūrėti paskyrą',
                'order_status' => 'Užsakymo būsena',
                'support_center' => 'Pagalbos centras',
                'shop_new_arrivals' => 'Naujos prekės',
            ],
        ],
        '404' => [
            'title' => 'Puslapis nerastas',
            'description' => 'Puslapis galėjo būti perkeltas arba jo nebėra. Patikrinkite adresą arba peržiūrėkite naudingas nuorodas žemiau.',
            'search_title' => 'Ieškoti kataloge',
            'search_placeholder' => 'Ieškokite produktų, prekės ženklų ar pagalbos',
            'top_categories_title' => 'Populiariausios kategorijos',
            'support_title' => 'Reikia pagalbos?',
            'support_description' => 'Pasidalykite žemiau esančiu ID su mūsų komanda ir padėsime rasti reikiamą vietą.',
            'contact_cta' => [
                'title' => 'Reikia asmeninės rekomendacijos?',
                'description' => 'Mūsų komanda padės išsirinkti tinkamą produktą arba atsakys į klausimus apie prieinamumą ir pristatymą.',
            ],
            'actions' => [
                'email_us' => 'Rašyti el. paštu',
                'visit_contact' => 'Aplankyti kontaktų puslapį',
            ],
        ],
        '419' => [
            'title' => 'Sesija baigėsi',
            'description' => 'Jūsų sesija baigėsi dėl neaktyvumo arba saugumo patikros. Atnaujinkite puslapį ir bandykite dar kartą.',
            'links' => [
                'review_cart' => 'Peržiūrėti krepšelį',
                'track_orders' => 'Sekti užsakymus',
            ],
        ],
        '429' => [
            'title' => 'Per daug užklausų',
            'description' => 'Šiuo metu gauname per daug užklausų. Padarykite trumpą pertrauką ir pabandykite vėliau.',
            'links' => [
                'read_news' => 'Skaityti naujienas',
            ],
        ],
        'search' => [
            'title'       => 'Ieškokite, ko reikia',
            'placeholder' => 'Ieškoti produktų...',
        ],
        'top_categories' => [
            'title' => 'Populiarios kategorijos',
        ],
        'support' => [
            'title'             => 'Reikia daugiau pagalbos?',
            'description'       => 'Jei problema išlieka, susisiekite su mūsų komanda ir pasidalinkite sekimo ID, kad galėtume greičiau padėti.',
            'email_support'     => 'Rašyti pagalbai',
            'visit_help_center' => 'Aplankyti pagalbos centrą',
            'view_system_status'=> 'Peržiūrėti sistemos būseną',
            'share_trace_id'    => 'Pasidalykite sekimo ID su mūsų komanda, kad greičiau rastume jūsų užklausą.',
        ],
        'actions' => [
            ...
            'check_system_status' => 'Peržiūrėti sistemos būseną',
            'visit_support_center' => 'Aplankyti pagalbos centrą',
            'read_updates'    => 'Skaityti naujienas',
            'view_status_page'=> 'Peržiūrėti būsenos puslapį',
            'browse_products' => 'Naršyti produktus',
            'try_again'       => 'Bandykite dar kartą',
            'browse_categories' => 'Naršyti kategorijas',
            'shop_products' => 'Pirkti produktus',
            'discover_brands' => 'Atrasti prekės ženklus',
        ...
        'popular_pages' => [
            'title'   => 'Populiarūs puslapiai',
            'explore' => 'Naršyti',
        ],
        'contact_cta' => [
            'title'       => 'Reikia daugiau pagalbos?',
            'description' => 'Susisiekite su mūsų komanda ir mes padėsime rasti sprendimą.',
        ],
        'trace_id' => 'Sekimo ID',
        '500' => [
            'title'              => 'Kažkas nepavyko',
            'description'        => 'Įvyko netikėta klaida. Mūsų komanda jau dirba su sprendimu.',
            'support_title'      => 'Reikia skubios pagalbos?',
            'support_description' => 'Pasidalykite žemiau esančiu ID su mūsų inžinieriais, kad kuo greičiau atstatytume paslaugą.',
        ],
        '503' => [
            'title'              => 'Netrukus grįšime',
            'description'        => 'Šiuo metu vykdome priežiūrą. Ačiū už kantrybę, kol geriname jūsų patirtį.',
            'support_title'      => 'Norite naujienų?',
            'support_description' => 'Patikrinkite būsenos puslapį arba susisiekite su pagalba ir pranešime, kai grįšime.',
        ],
        '5xx' => [
            'title'              => 'Klaida mūsų pusėje',
            'description'        => 'Apdorojant užklausą įvyko netikėta klaida. Mūsų komanda jau informuota ir tiria.',
            'support_title'      => 'Mūsų komanda jau tai tikrina',
            'support_description' => 'Pasidalykite sekimo ID, kad galėtume greičiau ištirti ir pranešti naujienas.',
        ],
    ],
    'cart'     => [
    ...
    'profile' => [
        ...
        'subtitle' => 'Tvarkykite asmeninę informaciją ir išsaugotus adresus.',
        'actions' => [
            'edit' => 'Redaguoti profilį',
            'manage_addresses' => 'Tvarkyti adresus',
        ],
        'overview' => [
            'title' => 'Paskyros apžvalga',
            'personal_details' => 'Asmeniniai duomenys',
        ],
        'account_details' => [
            'title' => 'Paskyros informacija',
            'description' => 'Ši informacija naudojama profiliui ir komunikacijai.',
        ],
        'fields' => [
            ...
            'default_billing' => 'Numatytasis atsiskaitymo adresas',
            'first_name' => 'Vardas',
            'last_name' => 'Pavardė',
            'billing_address' => 'Atsiskaitymo adreso eilutė',
            'postal_code' => 'Pašto kodas',
            'country' => 'Šalis',
        ...
        'addresses' => [
            'title' => 'Išsaugoti adresai',
            'description' => 'Greita adresų, naudojamų atsiskaitymo metu, apžvalga.',
            'empty' => 'Dar nesate išsaugoję adresų.',
            'empty_short' => 'Adresų dar nėra.',
            'empty_long' => 'Dar nepridėjote adresų. Naudokite formą žemiau, kad sukurtumėte pirmąjį.',
            'manage_cta' => 'Pridėti arba atnaujinti adresus',
            'manage_title' => 'Tvarkyti adresus',
            'heading' => 'Jūsų adresai',
            'subheading' => 'Sukurkite, atnaujinkite arba pašalinkite adresus, naudojamus atsiskaitymo metu.',
            'back' => 'Atgal į profilį',
            'errors_title' => 'Prašome pataisyti pažymėtus laukus.',
            'add_new_title' => 'Pridėti naują adresą',
            'add_new_description' => 'Užpildykite laukus, kad išsaugotumėte papildomą pristatymo ar sąskaitų adresą.',
            'badges' => [
                'default' => 'Numatytasis',
                'billing' => 'Sąskaitų',
                'shipping' => 'Pristatymo',
        ...
        'edit' => [
            ...
            'heading' => 'Atnaujinkite informaciją',
            'description' => 'Atnaujinkite paskyros informaciją, kad gautumėte tikslią komunikaciją ir atsiskaitymo duomenis.',
            'back' => 'Atgal į profilį',
            'actions' => [
                'cancel' => 'Atšaukti',
    ...
    'shop' => [
        'title' => 'Parduotuvė',
        'heading' => 'Minimalus el. shopas',
        'admin' => 'Administravimas',
        'empty' => 'Produktų dar nėra. Prisijunkite prie administratoriaus ir pridėkite produktų.',
    ],
    'exports' => [
        'title' => 'Eksportai',
        'empty' => 'Eksportų failų nerasta.',
        'table' => [
            'file' => 'Failas',
            'size' => 'Dydis (KB)',
            'download' => 'Atsisiųsti',
    ...
    'discounts' => [
        ...
        'value' => 'Vertė: :value',
        'empty' => 'Šiuo metu aktyvių nuolaidų nėra.',
        'view_coupons' => 'Peržiūrėti kuponus',
        'back' => 'Grįžti į nuolaidas',
        'offer' => [
            'title' => 'Pasiūlymo informacija',
            'type' => 'Tipas',
            'value' => 'Vertė',
            'active_from' => 'Galioja nuo',
            'expires_on' => 'Galioja iki',
            'immediately' => 'Nedelsiant',
            'no_expiry' => 'Be pabaigos',
        ],
        'coupons' => [
            'title' => 'Kuponai',
            'heading' => 'Galimi kuponai',
            'empty' => 'Šiuo metu kuponų nėra.',
        ],
    ],
    'user_dashboard' => [
        'title' => 'Mano skydelis',
        'subtitle' => 'Sveiki sugrįžę, tvarkykite paskyrą ir užsakymus',
        'stats' => [
        ...
        'recent_orders' => [
            ...
            'empty_description' => 'Apsipirkite, kad čia matytumėte užsakymus',
            'cta' => 'Pradėti apsipirkimą',
        ],
        'account' => [
            'title' => 'Paskyros informacija',
        ...
        'addresses' => [
            ...
            'manage' => 'Tvarkyti',
            'default' => 'Numatytasis',
            'empty_title' => 'Adresų dar nėra',
            'empty_description' => 'Pridėkite adresą, kad atsiskaitymas būtų greitesnis',
            'add' => 'Pridėti adresą',
        ],
    ],
    ...
    'categories' => [
        'index' => [
            'title'               => 'Kategorijos',
            'heading'             => 'Produktų kategorijos',
            'description'         => 'Naršykite visą kategorijų katalogą ir raskite tai, ko reikia jūsų projektui.',
            'view'                => 'Peržiūrėti',
            'description_fallback'=> 'Šioje kategorijoje rasite kruopščiai atrinktus įrankius ir priedus.',
            'empty_message'       => 'Kategorijos pasirodys, kai katalogas bus publikuotas. Užsukite vėliau!',
        ],
        'show' => [
    ...
    'brands' => [
        'index' => [
            ...
            'description'         => 'Atraskite patikimus gamintojus, siūlančius profesionalius įrankius ir įrangą.',
            'search_label'        => 'Ieškoti prekės ženklų',
            'search_placeholder'  => 'Ieškoti pagal pavadinimą…',
            'search_action'       => 'Ieškoti',
            'description_fallback'=> 'Specializuotas tiekėjas statybų profesionalams.',
            'product_count'       => '{0}Aktyvių produktų dar nėra|{1}1 aktyvus produktas|[2,*]:count aktyvūs produktai',
            'empty_message'       => 'Prekės ženklai bus paskelbti netrukus. Apsilankykite vėliau!',
        ],
        'show' => [
            'description_fallback' => 'Sužinokite daugiau apie šį gamintoją ir jo įrangą.',
            'visit_website'        => 'Aplankyti svetainę',
            'product_count'        => '{0}Aktyvių produktų dar nėra|{1}1 aktyvus produktas|[2,*]:count aktyvūs produktai',
            'products_from_brand'  => 'Šio prekės ženklo produktai',
            'search_label'         => 'Paieška',
            'search_placeholder'   => 'Ieškoti šio prekės ženklo produktų…',
            ...
            'empty_message'        => 'Šiam prekės ženklui produktų dar nėra.',
        ],
    ],
    'inventory' => [
        'title'       => 'Atsargų valdymas',
        'subtitle'    => 'Stebėkite ir valdykite produktų atsargas',
        'table_title' => 'Produktų atsargos',
        'columns' => [
            'product' => 'Produktas',
            'sku'     => 'SKU',
    ...
    'mail_previews' => [
        'title'        => 'El. pašto peržiūros',
        'heading'      => 'Operacinių laiškų peržiūros',
        'description'  => 'Greitai peržiūrėkite pagrindinių operacinių laiškų HTML. Atidarykite peržiūrą naujame skirtuke, kad patikrintumėte galutinį šabloną.',
        'locale_label' => 'Kalba',
    ],
    'pagination' => [
        'navigation' => 'Puslapiavimo navigacija',
        'previous'   => 'Ankstesnis',
        'next'       => 'Kitas',
        'showing'    => 'Rodoma',
        'to'         => 'iki',
    ...
    'filters' => [
        'title'             => 'Filtrai',
        'products_title'    => 'Filtruoti produktus',
        'description'       => 'Susiaurinkite paiešką, kad rastumėte tai, ko reikia',
    ...
    'products_grid' => [
        'empty_description' => 'Pabandykite pakoreguoti paiešką arba peržiūrėkite kategorijas',
    ],
    'order_summary' => [
        'subtotal'         => 'Tarpinė suma',
        'shipping'         => 'Pristatymas',
    ...
    'search' => [
        ...
        'action'                    => 'Ieškoti',
        'recent_searches'           => 'Nesenos paieškos',
    ...
    'search_results' => [
        ...
        'subtitle'    => 'Paieškos rezultatai pagal „:query“',
        'search_placeholder' => 'Ieškoti produktų...',
        'search_action' => 'Ieškoti',
        'found'       => 'Rasta',
        ...
        'refine_title' => 'Patikslinti rezultatus',
        'filters' => [
            'price_range' => 'Kainų intervalas',
            'min'         => 'Min.',
            'max'         => 'Maks.',
        ...
        'empty' => [
            ...
            'description' => 'Atsiprašome, nepavyko rasti produktų. Pabandykite kitus raktinius žodžius arba peržiūrėkite kategorijas.',
            'try_searching_for' => 'Pabandykite ieškoti',
        ],
        'suggestions' => [
            'title'            => 'Jums taip pat gali patikti',
            'popular_title'    => 'Populiarios paieškos',
    ...
    'wishlist' => [
        'add'    => 'Pridėti į norus',
        'remove' => 'Pašalinti iš norų',
        'save'   => 'Išsaugoti',
        'saved'  => 'Išsaugota',
        'added'  => 'Pridėta į norų sąrašą!',
        'removed'=> 'Pašalinta iš norų sąrašo!',
        'errors' => [
