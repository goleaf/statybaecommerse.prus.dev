...
- Address autocomplete helpers bypass user-owned scopes while still returning country metadata, ensuring admin panels and tests surface the same formatted suggestions even when no customer is authenticated.
