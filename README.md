...
### Latest updates
- Pest test helpers now guard the `login()` definition with an existence check, preventing redeclaration fatals during repeated `php artisan test` bootstrap cycles.
