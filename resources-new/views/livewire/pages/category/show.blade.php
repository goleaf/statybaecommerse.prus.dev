<div x-data="{ showFilters: false, viewMode: 'grid' }" class="min-h-screen bg-sage category-page">
    <x-container class="py-8 lg:py-12">
        ...
        <div class="mb-8">
            <div class="bg-dark border border-sage rounded-xl shadow-lg p-6 lg:p-8 text-sage">
                <div class="flex items-start justify-between gap-6">
                    <div class="flex-1">
                        <div class="flex items-center gap-3 mb-3">
                            <div class="w-12 h-12 bg-sage/20 rounded-xl flex items-center justify-center border border-sage">
                        ...
                        @if (!empty($category->description))
                            <p class="text-sage text-lg leading-relaxed max-w-3xl">{{ $category->description }}</p>
                        @endif
                    </div>
                ...
                <div class="mt-6 flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        <div class="px-4 py-2 rounded-lg border border-sage bg-dark/60">
                        ...
                        <div class="text-sm text-sage/90">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <aside class="lg:col-span-3">
                <div class="hidden lg:block sticky top-24 space-y-6 category-sidebar-scroll max-h-[calc(100vh-8rem)] overflow-auto pr-2">
                    <!-- Enhanced Categories Filter -->
                    <div class="bg-dark border border-sage rounded-xl shadow-lg overflow-hidden">
                        <div class="p-4 border-b border-sage bg-dark/80">
                            <h3 class="text-lg font-bold text-sage flex items-center gap-2">
                        ...
                        <div class="p-4">
                            <div class="category-tree theme-sage">
            ...
            <section class="lg:col-span-9">
                ...
                <div class="bg-dark border border-sage rounded-xl shadow-lg p-4 mb-6">
                    <div class="flex items-center justify-between gap-4">
                        ...
                        <div class="flex items-center gap-3">
                            <div class="flex items-center gap-2">
                                <label class="text-sm font-medium text-sage">{{ __('translations.sort_by') ?? 'Sort by' }}:</label>
                                <select wire:model.live="sortBy"
                                        class="rounded-lg border-sage bg-dark text-sm font-medium text-sage px-3 py-2 shadow-sm focus:outline-none">
                            ...
                            <div class="flex items-center gap-2">
                                <label class="text-sm font-medium text-sage">{{ __('translations.order') ?? 'Order' }}:</label>
                ...
                @if ($products->count() > 0)
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" 
                        ...
                        @foreach ($products as $product)
                            <div class="animate-fade-in-up animate-delay" data-delay="{{ $loop->index * 0.1 }}">
                                @include('livewire.home.partials.product-card', ['product' => $product])
                            </div>
                        @endforeach
                    </div>
                    ...
                    <div class="mt-12 flex justify-center">
                        <div class="bg-dark border border-sage rounded-xl shadow-lg p-4 text-sage">
