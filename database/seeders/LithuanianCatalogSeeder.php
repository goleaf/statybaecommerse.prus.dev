        ...
        $categories = [
            [
                ...
                'children' => [
                    ...
                    [
                        'name' => 'Pamatų vertikali ir horizontali hidroizoliacija',
                        'slug' => 'pamatu-vertikali-ir-horizontali-hidroizoliacija',
            ...
            [
                'name' => 'Tvirtinimo elementai, varžtai, medvaržčiai',
                ...
                'children' => [
                    ...
                    [
                        'name' => 'Tvirtinimas į betoną ir mūrą',
                        'slug' => 'tvirtinimas-i-betona-ir-mura',
                        ...
                        'children' => [
                            ...
                            ['name' => 'Įbetonuojami ankeriai ir sriegiai', 'slug' => 'ibetonuojami-ankeriai-sriegiai', 'description' => 'Įbetonuojamos detalės tvirtoms jungtims.', 'sort_order' => 6, 'image_url' => 'local://category/ibetonuojami-ankeriai-sriegiai.webp'],
                    ...
                    [
                        ...
                        'children' => [
                            ...
                            ['name' => 'Kolonų atramos', 'slug' => 'kolonu-atramos', 'description' => 'Reguliuojamos ir įbetonuojamos kolonų atramos.', 'sort_order' => 6, 'image_url' => 'local://category/kolonu-atramos.webp'],
                    ...
                    [
                        ...
                        'children' => [
                            ...
                            ['name' => 'Laikikliai ir kita', 'slug' => 'laikikliai-ir-kita', 'description' => 'Laikikliai ir kiti priedai.', 'sort_order' => 3, 'image_url' => 'local://category/laikikliai-ir-kita.webp'],
                    ...
                    ['name' => 'Išlyginimo kaladėlės ir kyliai', 'slug' => 'islyginimo-kaladele-kyliai', 'description' => 'Lygiavimo kaladėlės, kyliai ir priedai.', 'sort_order' => 9, 'image_url' => 'local://category/islyginimo-kaladeles-kyliai.webp'],
            ...
            [
                'name' => 'Įsukami ir įkalami poliai',
                'slug' => 'isukami-ir-ikalami-poliai',
                'description' => 'Poliai pamatams ir konstrukcijoms – įsukami ir įkalami.',
                'sort_order' => 3,
                'image_url' => 'local://category/poliai.webp',
                'children' => [
                    ['name' => '311 HDG', 'slug' => '311-hdg', 'description' => 'Cinkuoti poliai 311 HDG.', 'sort_order' => 1, 'image_url' => 'local://category/311-hdg.webp'],
            ...
            [
                ...
                'children' => [
                    ...
                    ['name' => 'EPDM darbui', 'slug' => 'epdm-darbui', 'description' => 'Įrankiai EPDM montavimui.', 'sort_order' => 4, 'image_url' => 'local://category/epdm-darbui.webp'],
                    ...
                    ['name' => 'Lankstytuvai ir žirklės skardai', 'slug' => 'lankstytuvai-zirkles-skardai', 'description' => 'Skardos lankstymo įrankiai ir žirklės.', 'sort_order' => 8, 'image_url' => 'local://category/lankstytuvai-zirkles.webp'],
                    ['name' => 'Kniedikliai', 'slug' => 'kniedikliai', 'description' => 'Kniedijimo įrankiai.', 'sort_order' => 9, 'image_url' => 'local://category/kniedikliai.webp'],
                    ['name' => 'Atsuktuvai ir galvutės', 'slug' => 'atsuktuvai-ir-galvutes', 'description' => 'Atsuktuvai ir antgaliai.', 'sort_order' => 10, 'image_url' => 'local://category/atsuktuvai-galvutes.webp'],
            ...
            [
                ...
                'children' => [
                    ['name' => 'EPDM (užsakymai) ir montavimo įrankiai', 'slug' => 'epdm-medziaga-ir-irankiai', 'description' => 'EPDM membranos užsakymams ir jų montavimo įrankiai.', 'sort_order' => 1, 'image_url' => 'local://category/epdm.webp'],
                    [
                        'name' => 'Stogų priedai',
                        'slug' => 'stogu-priedai',
                ...
                'children' => [
                    [
                        ...
                        'children' => [
                            ...
                            [
                                'name' => 'Priedai ventiliuojamiems fasadams',
                                'slug' => 'priedai-ventiliuojamiems-fasadams',
                                'description' => 'Tinkleliai, barjerai, profiliai, varžtai.',
                                'sort_order' => 2,
                                'image_url' => 'local://category/priedai-ventiliuojamiems-fasadams.webp',
                                'children' => [
            ...
            [
                'name' => 'Darbo apranga ir sauga',
                'slug' => 'darbo-apranga-ir-sauga',
