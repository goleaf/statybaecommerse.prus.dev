    ...
    public function run(): void
    {
        $translations = [
            'lt' => [
                ...
                'news.combobox.categories.available' => 'Galimos kategorijos',
                'news.combobox.categories.selected'  => 'Pasirinktos kategorijos',
                'news.combobox.tags.available'       => 'Galimos žymos',
                'news.combobox.tags.selected'        => 'Pasirinktos žymos',
            ...
            'en' => [
                ...
                'news.combobox.categories.available' => 'Available categories',
                'news.combobox.categories.selected'  => 'Selected categories',
                'news.combobox.tags.available'       => 'Available tags',
                'news.combobox.tags.selected'        => 'Selected tags',
