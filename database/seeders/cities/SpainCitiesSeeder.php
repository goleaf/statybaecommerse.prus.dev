...
final class SpainCitiesSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $cataloniaRegion = Region::where('code', 'ES-CT')->first();
        $andalusiaRegion = Region::where('code', 'ES-AN')->first();
        $valenciaRegion = Region::where('code', 'ES-VC')->first();
        $galiciaRegion = Region::where('code', 'ES-GA')->first();
        $castileLeonRegion = Region::where('code', 'ES-CL')->first();
        $basqueCountryRegion = Region::where('code', 'ES-PV')->first();
        $canaryIslandsRegion = Region::where('code', 'ES-CN')->first();
        $castileLaManchaRegion = Region::where('code', 'ES-CM')->first();
        $murciaRegion = Region::where('code', 'ES-MC')->first();
        $aragonRegion = Region::where('code', 'ES-AR')->first();
        $extremaduraRegion = Region::where('code', 'ES-EX')->first();
        $balearicIslandsRegion = Region::where('code', 'ES-IB')->first();
        $asturiasRegion = Region::where('code', 'ES-AS')->first();
        $navarreRegion = Region::where('code', 'ES-NC')->first();
        $cantabriaRegion = Region::where('code', 'ES-CB')->first();
        $laRiojaRegion = Region::where('code', 'ES-RI')->first();
        ...
        $cities = [
            ...
            [
                'name' => 'Valladolid',
                'code' => 'ES-CL-VAL',
                'region_id' => $castileLeonRegion?->id,
                'latitude' => 41.6523,
                'longitude' => -4.7245,
                'population' => 298412,
                'postal_codes' => ['47001'],
            ...
            [
                'name' => 'Bilbao',
                'code' => 'ES-PV-BIL',
                'region_id' => $basqueCountryRegion?->id,
                'latitude' => 43.2627,
                'longitude' => -2.9253,
                'population' => 346405,
                'postal_codes' => ['48001'],
            ...
            [
                ...
                'code' => 'ES-CN-LAS',
                'region_id' => $canaryIslandsRegion?->id,
                'latitude' => 28.1248,
                'longitude' => -15.43,
                'population' => 381123,
                'postal_codes' => ['35001'],
            ...
            [
                'name' => 'Toledo',
                'code' => 'ES-CM-TOL',
                'region_id' => $castileLaManchaRegion?->id,
                'latitude' => 39.8628,
                'longitude' => -4.0273,
                'population' => 85911,
                'postal_codes' => ['45001'],
            ...
            [
                'name' => 'Badajoz',
                'code' => 'ES-EX-BAD',
                'region_id' => $extremaduraRegion?->id,
                'latitude' => 38.8794,
                'longitude' => -6.9707,
                'population' => 150610,
                'postal_codes' => ['06001'],
            ...
            [
                'name' => 'Palma',
                'code' => 'ES-IB-PAL',
                'region_id' => $balearicIslandsRegion?->id,
                'latitude' => 39.5696,
                'longitude' => 2.6502,
                'population' => 416065,
                'postal_codes' => ['07001'],
