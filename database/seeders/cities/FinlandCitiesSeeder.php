...
final class FinlandCitiesSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Get regions
        $uusimaaRegion = Region::where('code', 'FI-18')->first();
        $varsinaisSuomiRegion = Region::where('code', 'FI-19')->first();
        $satakuntaRegion = Region::where('code', 'FI-17')->first();
        $kantaHameRegion = Region::where('code', 'FI-05')->first();
        $pirkanmaaRegion = Region::where('code', 'FI-11')->first();
        $paijatHameRegion = Region::where('code', 'FI-16')->first();
        $kymenlaaksoRegion = Region::where('code', 'FI-09')->first();
        $etelaKarjalaRegion = Region::where('code', 'FI-02')->first();
        $etelaSavoRegion = Region::where('code', 'FI-04')->first();
        $pohjoisSavoRegion = Region::where('code', 'FI-15')->first();
        $pohjoisKarjalaRegion = Region::where('code', 'FI-13')->first();
        $kainuuRegion = Region::where('code', 'FI-05')->first();
        $keskiSuomiRegion = Region::where('code', 'FI-08')->first();
        $etelaPohjanmaaRegion = Region::where('code', 'FI-03')->first();
        $pohjanmaaRegion = Region::where('code', 'FI-12')->first();
        $keskiPohjanmaaRegion = Region::where('code', 'FI-07')->first();
        $pohjoisPohjanmaaRegion = Region::where('code', 'FI-14')->first();
        $lappiRegion = Region::where('code', 'FI-10')->first();
        $ahvenanmaaRegion = Region::where('code', 'FI-01')->first();
        ...
        $cities = [
            ...
            [
                'name' => 'Turku',
                'code' => 'FI-19-TUR',
                'region_id' => $varsinaisSuomiRegion?->id,
                'latitude' => 60.4518,
                'longitude' => 22.2666,
                'population' => 195000,
                'postal_codes' => ['20000'],
            ...
            [
                'name' => 'Kotka',
                'code' => 'FI-09-KOT',
                'region_id' => $kymenlaaksoRegion?->id,
                'latitude' => 60.4667,
                'longitude' => 26.9167,
                'population' => 54000,
                'postal_codes' => ['48000'],
            ...
            [
                'name' => 'Lappeenranta',
                'code' => 'FI-02-LAP',
                'region_id' => $etelaKarjalaRegion?->id,
                'latitude' => 61.0667,
                'longitude' => 28.1833,
                'population' => 73000,
                'postal_codes' => ['53000'],
            ...
            [
                'name' => 'Kuopio',
                'code' => 'FI-15-KUO',
                'region_id' => $pohjoisSavoRegion?->id,
                'latitude' => 62.9000,
                'longitude' => 27.6833,
                'population' => 120000,
                'postal_codes' => ['70000'],
            ...
            [
                'name' => 'Joensuu',
                'code' => 'FI-13-JOE',
                'region_id' => $pohjoisKarjalaRegion?->id,
                'latitude' => 62.6000,
                'longitude' => 29.7500,
                'population' => 76000,
                'postal_codes' => ['80000'],
            ...
            [
                'name' => 'Seinäjoki',
                'code' => 'FI-03-SEI',
                'region_id' => $etelaPohjanmaaRegion?->id,
                'latitude' => 62.7833,
                'longitude' => 22.8333,
                'population' => 65000,
                'postal_codes' => ['60000'],
            ...
            [
                'name' => 'Kokkola',
                'code' => 'FI-07-KOK',
                'region_id' => $keskiPohjanmaaRegion?->id,
                'latitude' => 63.8333,
                'longitude' => 23.1333,
                'population' => 48000,
                'postal_codes' => ['67000'],
            ...
            [
                'name' => 'Oulu',
                'code' => 'FI-14-OUL',
                'region_id' => $pohjoisPohjanmaaRegion?->id,
                'latitude' => 65.0167,
                'longitude' => 25.4667,
                'population' => 210000,
                'postal_codes' => ['90000'],
