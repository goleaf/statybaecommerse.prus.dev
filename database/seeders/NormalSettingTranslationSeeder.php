    ...
    public function run(): void
    {
        $translations = [
            'lt' => [
                ...
                'normal_settings.tabs.all'          => 'Visi',
                'normal_settings.tabs.string'       => 'Tekstai',
                'normal_settings.tabs.integer'      => 'Sveikieji',
                'normal_settings.tabs.boolean'      => 'Loginiai',
                'normal_settings.tabs.array'        => 'Masyvai',
                'normal_settings.tabs.json'         => 'JSON',
                'normal_settings.tabs.public'       => 'Vieši',
                'normal_settings.tabs.private'      => 'Privatūs',
                'normal_settings.tabs.active'       => 'Aktyvūs',
            ...
            'en' => [
                ...
                'normal_settings.tabs.all'          => 'All',
                'normal_settings.tabs.string'       => 'Strings',
                'normal_settings.tabs.integer'      => 'Integers',
                'normal_settings.tabs.boolean'      => 'Booleans',
                'normal_settings.tabs.array'        => 'Arrays',
                'normal_settings.tabs.json'         => 'JSON',
                'normal_settings.tabs.public'       => 'Public',
                'normal_settings.tabs.private'      => 'Private',
                'normal_settings.tabs.active'       => 'Active',
