    ...
    public function run(): void
    {
        ...
        $cities = [
            ...
            [
                'name' => 'Stuttgart',
                'code' => 'DE-BW-STU',
                'region_id' => $badenWurttembergRegion?->id,
                'latitude' => 48.7758,
                'longitude' => 9.1829,
                'population' => 634830,
            ...
            [
                'name' => 'Cologne',
                'code' => 'DE-NW-COL',
                'region_id' => $northRhineWestphaliaRegion?->id,
                'latitude' => 50.9375,
                'longitude' => 6.9603,
                'population' => 1085664,
            ...
            [
                'name' => 'Hanover',
                'code' => 'DE-NI-HAN',
                'region_id' => $lowerSaxonyRegion?->id,
                'latitude' => 52.3759,
                'longitude' => 9.732,
                'population' => 535061,
            ...
            [
                'name' => 'Potsdam',
                'code' => 'DE-BB-POT',
                'region_id' => $brandenburgRegion?->id,
                'latitude' => 52.4009,
                'longitude' => 13.0591,
                'population' => 182112,
            ...
            [
                'name' => 'Magdeburg',
                'code' => 'DE-ST-MAG',
                'region_id' => $saxonyAnhaltRegion?->id,
                'latitude' => 52.1205,
                'longitude' => 11.6276,
                'population' => 238697,
            ...
            [
                'name' => 'Rostock',
                'code' => 'DE-MV-ROS',
                'region_id' => $mecklenburgVorpommernRegion?->id,
                'latitude' => 54.0887,
                'longitude' => 12.1401,
                'population' => 209191,
            ...
            [
                'name' => 'Kiel',
                'code' => 'DE-SH-KIE',
                'region_id' => $schleswigHolsteinRegion?->id,
                'latitude' => 54.3233,
                'longitude' => 10.1228,
                'population' => 247717,
            ...
            [
                'name' => 'Mainz',
                'code' => 'DE-RP-MAI',
                'region_id' => $rhinelandPalatinateRegion?->id,
                'latitude' => 49.9929,
                'longitude' => 8.2473,
                'population' => 217556,
