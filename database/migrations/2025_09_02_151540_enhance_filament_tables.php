...
return new class extends Migration {
    ...
    {
        // Products enhancements (forward-only canonical)
        ...
        // Users enhancements (forward-only canonical)
        ...
        // Orders enhancements (forward-only canonical)
        ...
        // Create settings table for application settings (forward-only canonical)
