    ...
    public function down(): void
    {
        ...
        if (Schema::hasTable('discount_campaigns')) {
            Schema::table('discount_campaigns', function (Blueprint $table) {
                ...
                // Drop indexes
                try { $table->dropIndex('campaigns_status_dates_idx'); } catch (\Throwable $e) {}
                try { $table->dropIndex('campaigns_featured_priority_idx'); } catch (\Throwable $e) {}
                try { $table->dropIndex('campaigns_channel_zone_idx'); } catch (\Throwable $e) {}
            });
        }
    }
};
