...
CREATE TABLE IF NOT EXISTS "analytics_events"(
  ...
  "conversion_currency" varchar not null default 'EUR',
  "notes" text,
  "user_name" varchar,
  "user_email" varchar,
  "event_data" text,
...
CREATE INDEX "analytics_events_event_type_created_at_index" on "analytics_events"(
  "event_type",
  "created_at"
);
CREATE INDEX "analytics_events_user_id_created_at_index" on "analytics_events"(
  "user_id",
  "created_at"
);
CREATE INDEX "analytics_events_session_id_created_at_index" on "analytics_events"(
  "session_id",
  "created_at"
);
CREATE INDEX "analytics_events_trackable_type_trackable_id_index" on "analytics_events"(
  "trackable_type",
  "trackable_id"
);
CREATE INDEX "analytics_events_device_type_created_at_index" on "analytics_events"(
  "device_type",
  "created_at"
);
CREATE INDEX "analytics_events_browser_created_at_index" on "analytics_events"(
  "browser",
  "created_at"
);
CREATE INDEX "analytics_events_country_code_created_at_index" on "analytics_events"(
  "country_code",
  "created_at"
);
CREATE INDEX "analytics_events_created_at_index" on "analytics_events"(
  "created_at"
);
CREATE INDEX "analytics_events_event_type_index" on "analytics_events"(
  "event_type"
);
CREATE INDEX "analytics_events_session_id_index" on "analytics_events"(
  "session_id"
);
CREATE INDEX "analytics_events_device_type_index" on "analytics_events"(
  "device_type"
);
...
CREATE UNIQUE INDEX "ui_translations_key_locale_unique" on "ui_translations"(
  "key",
  "locale"
);
CREATE INDEX "ui_translations_group_locale_index" on "ui_translations"(
  "group",
  "locale"
);
CREATE INDEX "ui_translations_key_group_index" on "ui_translations"(
  "key",
  "group"
);
CREATE INDEX "ui_translations_key_index" on "ui_translations"("key");
CREATE INDEX "ui_translations_locale_index" on "ui_translations"("locale");
CREATE INDEX "ui_translations_group_index" on "ui_translations"("group");
...
CREATE UNIQUE INDEX "notification_templates_slug_unique" on "notification_templates"(
  "slug"
);
...
CREATE INDEX "system_logs_level_logged_at_index" on "system_logs"(
  "level",
  "logged_at"
);
CREATE INDEX "system_logs_channel_logged_at_index" on "system_logs"(
  "channel",
  "logged_at"
);
CREATE INDEX "system_logs_user_id_index" on "system_logs"("user_id");
...
CREATE INDEX "audit_trails_auditable_type_auditable_id_index" on "audit_trails"(
  "auditable_type",
  "auditable_id"
);
CREATE INDEX "audit_trails_actor_type_actor_id_index" on "audit_trails"(
  "actor_type",
  "actor_id"
);
...
CREATE INDEX "audit_trails_request_id_index" on "audit_trails"("request_id");
...
CREATE INDEX "product_histories_causer_type_causer_id_index" on "product_histories"(
  "causer_type",
  "causer_id"
);
CREATE INDEX "product_histories_product_id_created_at_index" on "product_histories"(
  "product_id",
  "created_at"
);
CREATE INDEX "product_histories_user_id_created_at_index" on "product_histories"(
  "user_id",
  "created_at"
);
CREATE INDEX "product_histories_action_created_at_index" on "product_histories"(
  "action",
  "created_at"
);
CREATE INDEX "product_histories_field_name_index" on "product_histories"(
  "field_name"
);
CREATE TABLE IF NOT EXISTS "product_history_translations"(
  "id" integer primary key autoincrement not null,
  ...
  "description" text,
  "field_name" varchar,
  foreign key("product_history_id") references "product_histories"("id") on delete cascade
);
CREATE UNIQUE INDEX "product_history_translations_product_history_id_locale_unique" on "product_history_translations"(
  "product_history_id",
  "locale"
);
CREATE INDEX "product_history_translations_locale_index" on "product_history_translations"(
  "locale"
);
...
CREATE INDEX "campaign_views_campaign_id_viewed_at_index" on "campaign_views"(
  "campaign_id",
  "viewed_at"
);
CREATE INDEX "campaign_views_session_id_index" on "campaign_views"(
  "session_id"
);
CREATE INDEX "campaign_views_customer_id_index" on "campaign_views"(
  "customer_id"
);
CREATE TABLE IF NOT EXISTS "campaign_clicks"(
  ...
  "ip_address" varchar,
  "user_agent" varchar,
  "click_type" varchar not null default 'cta',
  "clicked_url" varchar,
  "customer_id" integer,
...
CREATE INDEX "campaign_clicks_campaign_id_clicked_at_index" on "campaign_clicks"(
  "campaign_id",
  "clicked_at"
);
CREATE INDEX "campaign_clicks_session_id_index" on "campaign_clicks"(
  "session_id"
);
CREATE INDEX "campaign_clicks_customer_id_index" on "campaign_clicks"(
  "customer_id"
);
CREATE INDEX "campaign_clicks_click_type_index" on "campaign_clicks"(
  "click_type"
);
CREATE TABLE IF NOT EXISTS "campaign_conversions"(
  ...
  "order_id" integer,
  "customer_id" integer,
  "conversion_type" varchar not null default 'purchase',
  "conversion_value" numeric not null default '0',
  "session_id" varchar,
  "conversion_data" text,
  ...
  "funnel_step" varchar,
  "attribution_model" varchar not null default 'last_click',
  "conversion_path" text,
  "touchpoints" text,
  "last_click_attribution" numeric,
  "first_click_attribution" numeric,
  "linear_attribution" numeric,
  "time_decay_attribution" numeric,
  "position_based_attribution" numeric,
  "data_driven_attribution" numeric,
  "conversion_window" integer not null default '30',
  "lookback_window" integer not null default '90',
  "assisted_conversions" integer not null default '0',
  "assisted_conversion_value" numeric not null default '0',
  "total_conversions" integer not null default '1',
  ...
  "updated_at" datetime,
  "is_verified" tinyint(1) not null default '0',
  "is_attributed" tinyint(1) not null default '0',
  foreign key("campaign_id") references "discount_campaigns"("id") on delete cascade,
  foreign key("click_id") references "campaign_clicks"("id") on delete set null,
  foreign key("order_id") references "orders"("id") on delete set null,
  foreign key("customer_id") references "users"("id") on delete set null
);
CREATE INDEX "campaign_conversions_campaign_id_converted_at_index" on "campaign_conversions"(
  "campaign_id",
  "converted_at"
);
CREATE INDEX "campaign_conversions_click_id_index" on "campaign_conversions"(
  "click_id"
);
CREATE INDEX "campaign_conversions_order_id_index" on "campaign_conversions"(
  "order_id"
);
CREATE INDEX "campaign_conversions_customer_id_index" on "campaign_conversions"(
  "customer_id"
);
CREATE INDEX "campaign_conversions_conversion_type_index" on "campaign_conversions"(
  "conversion_type"
);
CREATE TABLE IF NOT EXISTS "campaign_customer_segments"(
  ...
  "track_performance" tinyint(1) not null default '1',
...
CREATE INDEX "campaign_customer_segments_campaign_id_segment_type_index" on "campaign_customer_segments"(
  "campaign_id",
  "segment_type"
);
CREATE TABLE IF NOT EXISTS "campaign_product_targets"(
  "id" integer primary key autoincrement not null,
  "campaign_id" integer not null,
  "product_id" integer,
  "category_id" integer,
...
CREATE INDEX "campaign_product_targets_campaign_id_target_type_index" on "campaign_product_targets"(
  "campaign_id",
  "target_type"
);
CREATE INDEX "campaign_product_targets_is_active_is_featured_index" on "campaign_product_targets"(
  "is_active",
  "is_featured"
);
CREATE INDEX "campaign_product_targets_priority_weight_index" on "campaign_product_targets"(
  "priority",
  "weight"
);
CREATE UNIQUE INDEX "campaign_product_targets_campaign_id_brand_id_unique" on "campaign_product_targets"(
  "campaign_id",
  "brand_id"
);
CREATE UNIQUE INDEX "campaign_product_targets_campaign_id_collection_id_unique" on "campaign_product_targets"(
  "campaign_id",
  "collection_id"
);
...
CREATE INDEX "campaign_schedules_campaign_id_is_active_index" on "campaign_schedules"(
  "campaign_id",
  "is_active"
);
CREATE INDEX "campaign_schedules_next_run_at_index" on "campaign_schedules"(
  "next_run_at"
);
CREATE INDEX "campaign_clicks_device_type_index" on "campaign_clicks"(
  "device_type"
);
CREATE INDEX "campaign_clicks_browser_index" on "campaign_clicks"("browser");
CREATE INDEX "campaign_clicks_country_index" on "campaign_clicks"("country");
CREATE INDEX "campaign_clicks_utm_source_index" on "campaign_clicks"(
  "utm_source"
);
CREATE INDEX "campaign_clicks_is_converted_index" on "campaign_clicks"(
  "is_converted"
);
CREATE INDEX "campaign_clicks_clicked_at_campaign_id_index" on "campaign_clicks"(
  "clicked_at",
  "campaign_id"
);
CREATE TABLE IF NOT EXISTS "campaign_click_translations"(
  "id" integer primary key autoincrement not null,
  "campaign_click_id" integer not null,
  "locale" varchar not null,
  "click_type_label" varchar,
  "device_type_label" varchar,
  "browser_label" varchar,
  "os_label" varchar,
  "notes" text,
  "custom_data" text,
  foreign key("campaign_click_id") references "campaign_clicks"("id") on delete cascade
);
CREATE UNIQUE INDEX "campaign_click_locale_unique" on "campaign_click_translations"(
  "campaign_click_id",
  "locale"
);
CREATE INDEX "campaign_click_translations_locale_index" on "campaign_click_translations"(
  "locale"
);
CREATE TABLE IF NOT EXISTS "campaign_conversion_translations"(
  "id" integer primary key autoincrement not null,
  "campaign_conversion_id" integer not null,
  "locale" varchar not null,
  "conversion_type_label" varchar,
  ...
  "updated_at" datetime,
  "custom_attributes" text,
  foreign key("campaign_conversion_id") references "campaign_conversions"("id") on delete cascade
);
CREATE UNIQUE INDEX "campaign_conversion_locale_unique" on "campaign_conversion_translations"(
  "campaign_conversion_id",
  "locale"
);
CREATE INDEX "campaign_conversion_translations_locale_index" on "campaign_conversion_translations"(
  "locale"
);
...
CREATE UNIQUE INDEX "campaign_categories_unique" on "campaign_categories"(
  "campaign_id",
  "category_id"
);
CREATE INDEX "campaign_categories_campaign_idx" on "campaign_categories"(
  "campaign_id"
);
CREATE INDEX "campaign_categories_category_idx" on "campaign_categories"(
  "category_id"
);
...
CREATE UNIQUE INDEX "campaign_products_unique" on "campaign_products"(
  "campaign_id",
  "product_id"
);
CREATE INDEX "campaign_products_campaign_idx" on "campaign_products"(
  "campaign_id"
);
CREATE INDEX "campaign_products_product_idx" on "campaign_products"(
  "product_id"
);
...
CREATE UNIQUE INDEX "campaign_customer_groups_unique" on "campaign_customer_groups"(
  "campaign_id",
  "customer_group_id"
);
CREATE INDEX "campaign_customer_groups_campaign_idx" on "campaign_customer_groups"(
  "campaign_id"
);
CREATE INDEX "campaign_customer_groups_group_idx" on "campaign_customer_groups"(
  "customer_group_id"
);
...
CREATE UNIQUE INDEX "product_comparisons_session_id_product_id_unique" on "product_comparisons"(
  "session_id",
  "product_id"
);
CREATE UNIQUE INDEX "product_comparisons_user_id_product_id_unique" on "product_comparisons"(
  "user_id",
  "product_id"
);
CREATE INDEX "product_comparisons_product_id_index" on "product_comparisons"(
  "product_id"
);
...
CREATE INDEX "user_behaviors_user_id_behavior_type_created_at_index" on "user_behaviors"(
  "user_id",
  "behavior_type",
  "created_at"
);
CREATE INDEX "user_behaviors_session_id_behavior_type_created_at_index" on "user_behaviors"(
  "session_id",
  "behavior_type",
  "created_at"
);
CREATE INDEX "user_behaviors_product_id_behavior_type_created_at_index" on "user_behaviors"(
  "product_id",
  "behavior_type",
  "created_at"
);
CREATE INDEX "user_behaviors_session_id_index" on "user_behaviors"(
  "session_id"
);
CREATE INDEX "user_behaviors_created_at_index" on "user_behaviors"(
  "created_at"
);
...
CREATE UNIQUE INDEX "product_similarity_unique" on "product_similarities"(
  "product_id",
  "similar_product_id",
  "algorithm_type"
);
CREATE INDEX "product_similarity_score_idx" on "product_similarities"(
  "product_id",
  "algorithm_type",
  "similarity_score"
);
CREATE INDEX "product_similarity_type_idx" on "product_similarities"(
  "similar_product_id",
  "algorithm_type"
);
...
CREATE UNIQUE INDEX "user_preferences_user_id_preference_type_preference_key_unique" on "user_preferences"(
  "user_id",
  "preference_type",
  "preference_key"
);
CREATE INDEX "user_preferences_user_id_preference_type_preference_score_index" on "user_preferences"(
  "user_id",
  "preference_type",
  "preference_score"
);
CREATE TABLE IF NOT EXISTS "recommendation_configs"(
  ...
  "min_score" numeric not null default '0.1',
  "description" text,
  "created_at" datetime,
  "updated_at" datetime,
  "cache_ttl" integer not null default '3600',
...
CREATE INDEX "recommendation_configs_type_is_active_priority_index" on "recommendation_configs"(
  "type",
  "is_active",
  "priority"
);
CREATE UNIQUE INDEX "recommendation_configs_name_unique" on "recommendation_configs"(
  "name"
);
CREATE TABLE IF NOT EXISTS "recommendation_blocks"(
  "id" integer primary key autoincrement not null,
  "name" varchar not null,
  "title" varchar not null,
  "description" text,
  ...
  "created_at" datetime,
  "updated_at" datetime,
  "type" varchar not null default 'featured',
  "position" varchar not null default 'top',
  "sort_order" integer not null default '0',
  "show_title" tinyint(1) not null default '1',
  "show_description" tinyint(1) not null default '0',
  "is_default" tinyint(1) not null default '0'
);
CREATE INDEX "recommendation_blocks_is_active_name_index" on "recommendation_blocks"(
  "is_active",
  "name"
);
CREATE UNIQUE INDEX "recommendation_blocks_name_unique" on "recommendation_blocks"(
  "name"
);
...
CREATE INDEX "recommendation_cache_block_id_user_id_product_id_index" on "recommendation_cache"(
  "block_id",
  "user_id",
  "product_id"
);
CREATE INDEX "recommendation_cache_expires_at_index" on "recommendation_cache"(
  "expires_at"
);
CREATE INDEX "recommendation_cache_hit_count_index" on "recommendation_cache"(
  "hit_count"
);
CREATE UNIQUE INDEX "recommendation_cache_cache_key_unique" on "recommendation_cache"(
  "cache_key"
);
CREATE TABLE IF NOT EXISTS "recommendation_analytics"(
  ...
  "updated_at" datetime,
  foreign key("block_id") references "recommendation_blocks"("id") on delete cascade,
  foreign key("config_id") references "recommendation_configs"("id") on delete cascade,
  foreign key("user_id") references "users"("id") on delete cascade,
  foreign key("product_id") references "products"("id") on delete cascade
);
CREATE INDEX "recommendation_analytics_block_id_date_index" on "recommendation_analytics"(
  "block_id",
  "date"
);
CREATE INDEX "recommendation_analytics_config_id_date_index" on "recommendation_analytics"(
  "config_id",
  "date"
);
CREATE INDEX "recommendation_analytics_action_date_index" on "recommendation_analytics"(
  "action",
  "date"
);
...
CREATE UNIQUE INDEX "product_features_product_id_feature_type_feature_key_unique" on "product_features"(
  "product_id",
  "feature_type",
  "feature_key"
);
CREATE INDEX "product_features_feature_type_feature_key_index" on "product_features"(
  "feature_type",
  "feature_key"
);
...
CREATE TABLE IF NOT EXISTS "variant_price_histories"(
  "id" integer primary key autoincrement not null,
  "variant_id" integer not null,
  "old_price" numeric not null,
  "new_price" numeric not null,
  "price_type" varchar not null default 'regular',
  "reason" varchar,
  "change_reason" varchar,
  "changed_by" integer,
...
CREATE INDEX "variant_price_histories_variant_id_price_type_created_at_index" on "variant_price_histories"(
  "variant_id",
  "price_type",
  "created_at"
);
CREATE INDEX "variant_price_histories_effective_from_effective_until_index" on "variant_price_histories"(
  "effective_from",
  "effective_until"
);
CREATE TABLE IF NOT EXISTS "variant_stock_history"(
  ...
  "change_type" varchar not null default 'adjustment',
  "change_reason" varchar,
  "changed_by" integer,
...
CREATE INDEX "variant_stock_history_variant_id_change_type_created_at_index" on "variant_stock_history"(
  "variant_id",
  "change_type",
  "created_at"
);
CREATE INDEX "variant_stock_history_reference_type_reference_id_index" on "variant_stock_history"(
  "reference_type",
  "reference_id"
);
CREATE TABLE IF NOT EXISTS "variant_recommendations"(
  "id" integer primary key autoincrement not null,
  "variant_id" integer not null,
  "recommended_variant_id" integer not null,
  "recommendation_type" varchar not null default 'similar',
  ...
  "updated_at" datetime,
  foreign key("variant_id") references "product_variants"("id") on delete cascade,
  foreign key("recommended_variant_id") references "product_variants"("id") on delete cascade
);
CREATE UNIQUE INDEX "variant_recommendations_variant_id_recommended_variant_id_unique" on "variant_recommendations"(
  "variant_id",
  "recommended_variant_id"
);
CREATE INDEX "variant_recommend_type_idx" on "variant_recommendations"(
  "recommendation_type",
  "confidence_score"
);
CREATE INDEX "variant_recommendations_is_active_sort_order_index" on "variant_recommendations"(
  "is_active",
  "sort_order"
);
...
CREATE TABLE IF NOT EXISTS "referral_code_usage_logs"(
  "id" integer primary key autoincrement not null,
...
CREATE INDEX "referral_code_usage_logs_referral_code_id_created_at_index" on "referral_code_usage_logs"(
  "referral_code_id",
  "created_at"
);
CREATE INDEX "referral_code_usage_logs_user_id_created_at_index" on "referral_code_usage_logs"(
  "user_id",
  "created_at"
);
CREATE INDEX "referral_code_usage_logs_ip_address_created_at_index" on "referral_code_usage_logs"(
  "ip_address",
  "created_at"
);
CREATE TABLE IF NOT EXISTS "referral_code_statistics"(
  "id" integer primary key autoincrement not null,
  "referral_code_id" integer not null,
  "date" date not null,
...
CREATE UNIQUE INDEX "referral_code_statistics_referral_code_id_date_unique" on "referral_code_statistics"(
  "referral_code_id",
  "date"
);
CREATE INDEX "referral_code_statistics_date_index" on "referral_code_statistics"(
  "date"
);
CREATE TABLE IF NOT EXISTS "referral_statistics"(
  ...
  "total_discounts_given" numeric not null default '0',
  "metadata" text,
  "created_at" datetime,
  "updated_at" datetime,
  foreign key("user_id") references "users"("id") on delete cascade
);
CREATE UNIQUE INDEX "referral_statistics_user_id_date_unique" on "referral_statistics"(
  "user_id",
  "date"
);
CREATE INDEX "referral_statistics_date_index" on "referral_statistics"("date");
...
CREATE INDEX "campaign_conversions_status_index" on "campaign_conversions"(
  "status"
);
CREATE INDEX "campaign_conversions_source_index" on "campaign_conversions"(
  "source"
);
CREATE INDEX "campaign_conversions_medium_index" on "campaign_conversions"(
  "medium"
);
CREATE INDEX "campaign_conversions_device_type_index" on "campaign_conversions"(
  "device_type"
);
CREATE INDEX "campaign_conversions_country_index" on "campaign_conversions"(
  "country"
);
CREATE INDEX "campaign_conversions_conversion_type_status_index" on "campaign_conversions"(
  "conversion_type",
  "status"
);
CREATE INDEX "campaign_conversions_converted_at_status_index" on "campaign_conversions"(
  "converted_at",
  "status"
);
CREATE INDEX "campaign_conversions_campaign_id_conversion_type_index" on "campaign_conversions"(
  "campaign_id",
  "conversion_type"
);
CREATE INDEX "campaign_conversions_customer_id_converted_at_index" on "campaign_conversions"(
  "customer_id",
  "converted_at"
);
...
CREATE INDEX "order_items_product_variant_id_index" on "order_items"(
  "product_variant_id"
);
...
CREATE UNIQUE INDEX "product_analytics_product_id_date_unique" on "product_analytics"(
  "product_id",
  "date"
);
CREATE INDEX "product_analytics_date_views_index" on "product_analytics"(
  "date",
  "views"
);
CREATE INDEX "product_analytics_date_purchases_index" on "product_analytics"(
  "date",
  "purchases"
);
...
CREATE INDEX "search_logs_query_index" on "search_logs"("query");
CREATE INDEX "search_logs_searched_at_index" on "search_logs"("searched_at");
CREATE INDEX "search_logs_results_count_index" on "search_logs"(
  "results_count"
);
...
CREATE INDEX "reports_type_category_index" on "reports"("type", "category");
CREATE INDEX "reports_is_active_is_public_index" on "reports"(
  "is_active",
  "is_public"
);
CREATE INDEX "reports_created_at_updated_at_index" on "reports"(
  "created_at",
  "updated_at"
);
CREATE INDEX "reports_view_count_index" on "reports"("view_count");
CREATE INDEX "reports_download_count_index" on "reports"("download_count");
CREATE UNIQUE INDEX "reports_slug_unique" on "reports"("slug");
CREATE INDEX "reports_type_index" on "reports"("type");
CREATE INDEX "reports_category_index" on "reports"("category");
...
CREATE UNIQUE INDEX "campaign_translations_campaign_id_locale_unique" on "campaign_translations"(
  "campaign_id",
  "locale"
);
CREATE INDEX "campaign_translations_locale_index" on "campaign_translations"(
  "locale"
);
CREATE INDEX "campaign_translations_slug_index" on "campaign_translations"(
  "slug"
);
...
CREATE INDEX "news_categories_is_visible_index" on "news_categories"(
  "is_visible"
);
CREATE INDEX "news_categories_parent_id_index" on "news_categories"(
  "parent_id"
);
CREATE INDEX "news_categories_sort_order_index" on "news_categories"(
  "sort_order"
);
CREATE UNIQUE INDEX "news_categories_slug_unique" on "news_categories"("slug");
...
CREATE INDEX "news_category_translations_locale_index" on "news_category_translations"(
  "locale"
);
CREATE UNIQUE INDEX "news_category_translations_news_category_id_locale_unique" on "news_category_translations"(
  "news_category_id",
  "locale"
);
CREATE UNIQUE INDEX "news_category_translations_locale_slug_unique" on "news_category_translations"(
  "locale",
  "slug"
);
CREATE TABLE IF NOT EXISTS "news_category_pivot"(
  "news_id" integer not null,
  "news_category_id" integer not null,
  "created_at" datetime,
  "updated_at" datetime,
...
CREATE INDEX "news_category_pivot_news_id_index" on "news_category_pivot"(
  "news_id"
);
CREATE INDEX "news_category_pivot_news_category_id_index" on "news_category_pivot"(
  "news_category_id"
);
...
CREATE INDEX "news_tags_is_visible_index" on "news_tags"("is_visible");
CREATE INDEX "news_tags_sort_order_index" on "news_tags"("sort_order");
...
CREATE INDEX "sh_news_tag_translations_locale_index" on "news_tag_translations"(
  "locale"
);
CREATE UNIQUE INDEX "sh_news_tag_translations_news_tag_id_locale_unique" on "news_tag_translations"(
  "news_tag_id",
  "locale"
);
CREATE UNIQUE INDEX "sh_news_tag_translations_locale_slug_unique" on "news_tag_translations"(
  "locale",
  "slug"
);
CREATE TABLE IF NOT EXISTS "news_tag_pivot"(
  "news_id" integer not null,
  "news_tag_id" integer not null,
  primary key("news_id", "news_tag_id")
);
CREATE INDEX "news_tag_pivot_news_id_index" on "news_tag_pivot"("news_id");
CREATE INDEX "news_tag_pivot_news_tag_id_index" on "news_tag_pivot"(
  "news_tag_id"
);
...
CREATE INDEX "news_comments_parent_id_index" on "news_comments"("parent_id");
CREATE INDEX "news_comments_is_approved_index" on "news_comments"(
  "is_approved"
);
CREATE INDEX "news_comments_is_visible_index" on "news_comments"("is_visible");
...
CREATE INDEX "news_images_is_featured_index" on "news_images"("is_featured");
CREATE INDEX "news_images_sort_order_index" on "news_images"("sort_order");
...
CREATE TABLE IF NOT EXISTS "campaign_discount"(
  ...
  "created_at" datetime,
  "updated_at" datetime,
  foreign key("discount_id") references discounts("id") on delete cascade on update no action,
  foreign key("campaign_id") references discount_campaigns("id") on delete cascade on update no action,
  foreign key("campaign_id") references "discount_campaigns"("id") on delete cascade,
  foreign key("discount_id") references "discounts"("id") on delete cascade
);
CREATE UNIQUE INDEX "campaign_discount_campaign_id_discount_id_unique" on "campaign_discount"(
  "campaign_id",
  "discount_id"
);
CREATE INDEX "campaign_discount_campaign_id_index" on "campaign_discount"(
  "campaign_id"
);
CREATE INDEX "campaign_discount_discount_id_index" on "campaign_discount"(
  "discount_id"
);
...
CREATE INDEX "shipping_options_zone_id_is_enabled_index" on "shipping_options"(
  "zone_id",
  "is_enabled"
);
CREATE INDEX "shipping_options_is_default_is_enabled_index" on "shipping_options"(
  "is_default",
  "is_enabled"
);
...
CREATE TABLE IF NOT EXISTS "recommendation_config_simples"(
  "id" integer primary key autoincrement not null,
  "name" varchar not null,
  "code" varchar not null,
  "description" text,
  "algorithm_type" varchar not null default 'collaborative',
  "min_score" numeric not null default '0.1',
  "max_results" integer not null default '10',
  "decay_factor" numeric not null default '0.9',
  "exclude_out_of_stock" tinyint(1) not null default '1',
  "exclude_inactive" tinyint(1) not null default '1',
  "price_weight" numeric not null default '0.2',
  "rating_weight" numeric not null default '0.3',
  "popularity_weight" numeric not null default '0.2',
  "recency_weight" numeric not null default '0.1',
  "category_weight" numeric not null default '0.2',
  "custom_weight" numeric not null default '0',
  "cache_duration" integer not null default '60',
  "is_active" tinyint(1) not null default '1',
  "is_default" tinyint(1) not null default '0',
  "sort_order" integer not null default '0',
  "notes" text,
...
CREATE INDEX "recommendation_config_simples_is_active_sort_order_index" on "recommendation_config_simples"(
  "is_active",
  "sort_order"
);
CREATE INDEX "recommendation_config_simples_algorithm_type_is_active_index" on "recommendation_config_simples"(
  "algorithm_type",
  "is_active"
);
CREATE INDEX "recommendation_config_simples_is_default_index" on "recommendation_config_simples"(
  "is_default"
);
CREATE UNIQUE INDEX "recommendation_config_simples_code_unique" on "recommendation_config_simples"(
  "code"
);
CREATE TABLE IF NOT EXISTS "recommendation_config_simple_products"(
  "id" integer primary key autoincrement not null,
  "recommendation_config_simple_id" integer not null,
  "product_id" integer not null,
  "created_at" datetime,
  "updated_at" datetime,
  foreign key("recommendation_config_simple_id") references "recommendation_config_simples"("id") on delete cascade,
  foreign key("product_id") references "products"("id") on delete cascade
);
CREATE UNIQUE INDEX "rcsp_unique" on "recommendation_config_simple_products"(
  "recommendation_config_simple_id",
  "product_id"
);
CREATE TABLE IF NOT EXISTS "recommendation_config_simple_categories"(
  "id" integer primary key autoincrement not null,
  "recommendation_config_simple_id" integer not null,
  "category_id" integer not null,
  "created_at" datetime,
...
CREATE UNIQUE INDEX "rcsc_unique" on "recommendation_config_simple_categories"(
  "recommendation_config_simple_id",
  "category_id"
);
...
CREATE TABLE IF NOT EXISTS "recommendation_config_products"(
  "id" integer primary key autoincrement not null,
  "recommendation_config_id" integer not null,
  "product_id" integer not null,
  "created_at" datetime,
  "updated_at" datetime,
  foreign key("recommendation_config_id") references "recommendation_configs"("id") on delete cascade,
  foreign key("product_id") references "products"("id") on delete cascade
);
CREATE UNIQUE INDEX "rcp_unique" on "recommendation_config_products"(
  "recommendation_config_id",
  "product_id"
);
CREATE TABLE IF NOT EXISTS "recommendation_config_categories"(
  "id" integer primary key autoincrement not null,
  "recommendation_config_id" integer not null,
  "category_id" integer not null,
  "created_at" datetime,
...
CREATE UNIQUE INDEX "rcc_unique" on "recommendation_config_categories"(
  "recommendation_config_id",
  "category_id"
);
CREATE TABLE IF NOT EXISTS "recommendation_block_products"(
  "id" integer primary key autoincrement not null,
  "recommendation_block_id" integer not null,
  "product_id" integer not null,
  "created_at" datetime,
  "updated_at" datetime,
  foreign key("recommendation_block_id") references "recommendation_blocks"("id") on delete cascade,
  foreign key("product_id") references "products"("id") on delete cascade
);
CREATE UNIQUE INDEX "rbp_unique" on "recommendation_block_products"(
  "recommendation_block_id",
  "product_id"
);
CREATE INDEX "recommendation_block_products_product_id_index" on "recommendation_block_products"(
  "product_id"
);
CREATE INDEX "news_categories_is_active_index" on "news_categories"(
  "is_active"
);
CREATE INDEX "news_tags_is_active_index" on "news_tags"("is_active");
CREATE INDEX "news_comments_is_active_index" on "news_comments"("is_active");
CREATE INDEX "news_images_is_active_index" on "news_images"("is_active");
...
CREATE INDEX "campaign_views_ip_idx" on "campaign_views"("ip_address");
CREATE INDEX "campaign_views_campaign_customer_idx" on "campaign_views"(
  "campaign_id",
  "customer_id"
);
CREATE INDEX "campaign_clicks_ip_idx" on "campaign_clicks"("ip_address");
CREATE INDEX "campaign_clicks_campaign_customer_idx" on "campaign_clicks"(
  "campaign_id",
  "customer_id"
);
CREATE INDEX "campaign_conversions_session_idx" on "campaign_conversions"(
  "session_id"
);
CREATE INDEX "campaign_customer_segments_active_segment_idx" on "campaign_customer_segments"(
  "is_active",
  "segment_type"
);
CREATE INDEX "campaign_customer_segments_sort_idx" on "campaign_customer_segments"(
  "sort_order"
);
CREATE INDEX "campaign_product_targets_product_idx" on "campaign_product_targets"(
  "product_id"
);
CREATE INDEX "campaign_product_targets_category_idx" on "campaign_product_targets"(
  "category_id"
);
...
CREATE INDEX "variant_analytics_date_views_clicks_index" on "variant_analytics"(
  "date",
  "views",
  "clicks"
);
CREATE INDEX "variant_analytics_variant_id_conversion_rate_index" on "variant_analytics"(
  "variant_id",
  "conversion_rate"
);
CREATE UNIQUE INDEX "variant_analytics_product_variant_bucket_unique" on "variant_analytics"(
  "product_id",
  "variant_id",
  "date_bucket"
);
...
CREATE INDEX "order_shippings_order_id_index" on "order_shippings"("order_id");
...
CREATE INDEX "news_approvals_news_id_decided_at_index" on "news_approvals"(
  "news_id",
  "decided_at"
);
...
CREATE UNIQUE INDEX "dead_letter_jobs_uuid_unique" on "dead_letter_jobs"(
  "uuid"
);
CREATE INDEX "dead_letter_jobs_connection_index" on "dead_letter_jobs"(
  "connection"
);
CREATE INDEX "dead_letter_jobs_queue_index" on "dead_letter_jobs"("queue");
...
CREATE INDEX "shipping_options_country_city_idx" on "shipping_options"(
  "country_id",
  "city_id"
);
CREATE TABLE IF NOT EXISTS "orders"(
  ...
  "country_id" integer,
  "payment_state" varchar not null default 'created',
  foreign key("shipping_option_id") references shipping_options("id") on delete set null on update no action,
...
CREATE INDEX "orders_customer_id_created_at_index" on "orders"(
  "customer_id",
  "created_at"
);
CREATE UNIQUE INDEX "orders_number_unique" on "orders"("number");
CREATE INDEX "orders_shipping_option_id_index" on "orders"(
  "shipping_option_id"
);
...
CREATE INDEX "price_lists_country_enabled_idx" on "price_lists"(
  "country_id",
  "is_enabled"
);
CREATE TABLE IF NOT EXISTS "discounts"(
  ...
  "deleted_at" datetime,
  "country_id" integer,
  foreign key("zone_id") references zones("id") on delete set null on update no action,
  foreign key("country_id") references "countries"("id") on delete set null
);
...
CREATE TABLE IF NOT EXISTS "discount_campaigns"(
  ...
  "auto_end" tinyint(1) not null default('0'),
  "auto_pause_on_budget" tinyint(1) not null default('0'),
  "meta_title" varchar,
  "meta_description" text,
  "social_media_ready" tinyint(1) not null default('0'),
  "is_featured" tinyint(1) not null default('0'),
  "send_notifications" tinyint(1) not null default('1'),
  "track_conversions" tinyint(1) not null default('1'),
  "max_uses" integer,
...
CREATE INDEX "campaigns_channel_zone_idx" on "discount_campaigns"(
  "channel_id",
  "zone_id"
);
CREATE INDEX "campaigns_status_dates_idx" on "discount_campaigns"(
  "status",
  "starts_at",
  "ends_at"
);
...
CREATE INDEX "discount_campaigns_channel_status_idx" on "discount_campaigns"(
  "channel_id",
  "status"
);
CREATE INDEX "discount_campaigns_dates_idx" on "discount_campaigns"(
  "starts_at",
  "ends_at"
);
...
CREATE INDEX "discount_campaigns_status_featured_priority_idx" on "discount_campaigns"(
  "status",
  "is_featured",
  "display_priority"
);
...
CREATE INDEX "discount_campaigns_country_status_idx" on "discount_campaigns"(
  "country_id",
  "status"
);
CREATE TABLE IF NOT EXISTS "zone_migration_issues"(
  "id" integer primary key autoincrement not null,
...
CREATE INDEX "zone_migration_lookup_idx" on "zone_migration_issues"(
  "table_name",
  "record_id"
);
...
CREATE INDEX "user_product_interaction_unique" on "user_product_interactions"(
  "user_id",
  "product_id",
  "event"
);
CREATE INDEX "user_interactions_last_idx" on "user_product_interactions"(
  "user_id",
  "event",
  "last_interaction"
);
CREATE INDEX "user_interactions_product_idx" on "user_product_interactions"(
  "product_id",
  "event",
  "count"
);
...
CREATE TABLE IF NOT EXISTS "performance_metrics"(
  ...
  "environment" varchar not null default 'local',
  "additional_metrics" text,
  "created_at" datetime,
  "updated_at" datetime
);
CREATE INDEX "performance_metrics_page_route_created_at_index" on "performance_metrics"(
  "page_route",
  "created_at"
);
CREATE INDEX "performance_metrics_environment_index" on "performance_metrics"(
  "environment"
);
CREATE INDEX "performance_metrics_route_date_idx" on "performance_metrics"(
  "page_route",
  "created_at"
);
CREATE INDEX "performance_metrics_environment_idx" on "performance_metrics"(
  "environment"
);
CREATE INDEX "performance_metrics_aggregation_idx" on "performance_metrics"(
  "page_route",
  "environment",
  "created_at"
);
...
CREATE INDEX "products_storefront_visibility_idx" on "products"(
  "is_visible",
  "is_enabled",
  "published_at"
);
CREATE INDEX "products_price_visibility_idx" on "products"(
  "price",
  "is_visible"
);
CREATE INDEX "products_stock_visibility_idx" on "products"(
  "stock_quantity",
  "is_visible"
);
CREATE INDEX "products_popularity_idx" on "products"(
  "view_count",
  "is_visible"
);
CREATE INDEX "product_translations_locale_product_idx" on "product_translations"(
  "locale",
  "product_id"
);
CREATE INDEX "brands_active_sort_idx" on "brands"("is_active", "sort_order");
CREATE INDEX "collections_visibility_sort_idx" on "collections"(
  "is_visible",
  "is_enabled",
  "sort_order"
);
CREATE INDEX "categories_hierarchy_idx" on "categories"(
  "parent_id",
  "is_visible",
  "sort_order"
);
CREATE INDEX "product_categories_category_product_idx" on "product_categories"(
  "category_id",
  "product_id"
);
CREATE INDEX "product_collections_collection_product_idx" on "product_collections"(
  "collection_id",
  "product_id"
);
CREATE INDEX "reviews_product_approved_idx" on "reviews"(
  "product_id",
  "is_approved",
  "created_at"
);
CREATE INDEX "orders_analytics_idx" on "orders"("created_at", "status");
CREATE INDEX "performance_metrics_route_time_idx" on "performance_metrics"(
  "page_route",
  "created_at"
);
...
INSERT INTO migrations VALUES(7,'2024_09_12_200000_create_analytics_events_table',1);
INSERT INTO migrations VALUES(8,'2024_10_21_000000_create_exports_table',1);
INSERT INTO migrations VALUES(9,'2025_01_10_000000_create_customer_groups_table',1);
INSERT INTO migrations VALUES(10,'2025_01_15_000000_add_missing_fields_to_customer_groups_table',1);
INSERT INTO migrations VALUES(11,'2025_01_20_130000_enhance_users_table_with_translations_and_additional_fields',1);
INSERT INTO migrations VALUES(12,'2025_01_21_120000_enhance_products_table_comprehensive',1);
INSERT INTO migrations VALUES(13,'2025_01_25_120000_create_ui_translations_table',1);
INSERT INTO migrations VALUES(14,'2025_01_27_000001_create_document_templates_table',1);
INSERT INTO migrations VALUES(15,'2025_01_27_000002_create_documents_table',1);
INSERT INTO migrations VALUES(16,'2025_01_27_010000_add_updated_by_to_documents_table',1);
INSERT INTO migrations VALUES(17,'2025_01_28_000001_create_enhanced_filament_system_tables',1);
INSERT INTO migrations VALUES(18,'2025_01_28_120000_create_user_wishlists_table',1);
INSERT INTO migrations VALUES(19,'2025_01_28_130000_enhance_users_table_with_comprehensive_fields',1);
INSERT INTO migrations VALUES(20,'2025_01_30_120001_add_soft_deletes_to_cart_items_table',1);
INSERT INTO migrations VALUES(21,'2025_01_31_000001_create_system_settings_tables',1);
INSERT INTO migrations VALUES(22,'2025_01_31_000002_add_additional_fields_to_system_settings_table',1);
INSERT INTO migrations VALUES(23,'2025_01_31_000002_add_enhanced_fields_to_system_setting_translations_table',1);
INSERT INTO migrations VALUES(24,'2025_01_31_000003_add_meta_columns_to_system_setting_tables',1);
INSERT INTO migrations VALUES(25,'2025_01_31_000004_add_minimum_quantity_to_cart_items_table',1);
INSERT INTO migrations VALUES(26,'2025_02_01_000001_add_indexes_to_seo_data',1);
INSERT INTO migrations VALUES(27,'2025_02_01_000002_add_condition_value_to_system_setting_dependencies_table',1);
INSERT INTO migrations VALUES(28,'2025_02_05_000000_add_condition_value_to_system_setting_dependencies_table',1);
INSERT INTO migrations VALUES(29,'2025_02_10_000000_create_personal_access_tokens_table',1);
INSERT INTO migrations VALUES(30,'2025_02_14_000000_create_audit_logs_table',1);
INSERT INTO migrations VALUES(31,'2025_02_14_000001_create_audit_trails_table',1);
INSERT INTO migrations VALUES(32,'2025_02_15_000000_add_deleted_at_to_customer_groups_table',1);
INSERT INTO migrations VALUES(33,'2025_02_15_120000_add_created_at_indexes',1);
INSERT INTO migrations VALUES(34,'2025_02_20_120000_add_visual_and_financial_fields_to_customer_groups_table',1);
INSERT INTO migrations VALUES(35,'2025_02_24_120000_create_table_settings_table',1);
INSERT INTO migrations VALUES(36,'2025_05_16_183635_create_table_settings_table',1);
INSERT INTO migrations VALUES(37,'2025_08_31_183927_create_media_table',1);
INSERT INTO migrations VALUES(38,'2025_08_31_192639_create_telescope_entries_table',1);
INSERT INTO migrations VALUES(39,'2025_08_31_200000_extend_discounts_and_create_discount_tables',1);
INSERT INTO migrations VALUES(40,'2025_08_31_200100_create_translation_tables',1);
INSERT INTO migrations VALUES(41,'2025_08_31_200200_create_groups_partners_price_lists',1);
INSERT INTO migrations VALUES(42,'2025_08_31_210000_add_performance_indexes',1);
INSERT INTO migrations VALUES(43,'2025_08_31_210100_add_price_indexes',1);
INSERT INTO migrations VALUES(44,'2025_09_01_000010_add_preferred_locale_to_users_table',1);
INSERT INTO migrations VALUES(45,'2025_09_01_000020_add_unique_slug_locale_indexes',1);
INSERT INTO migrations VALUES(46,'2025_09_01_000100_create_discount_codes_table',1);
INSERT INTO migrations VALUES(47,'2025_09_01_000500_add_price_composite_index',1);
INSERT INTO migrations VALUES(48,'2025_09_01_010000_add_payment_fields_to_orders_table',1);
INSERT INTO migrations VALUES(49,'2025_09_01_010100_add_timeline_to_orders_table',1);
INSERT INTO migrations VALUES(50,'2025_09_01_010200_add_tracking_to_order_shippings_table',1);
INSERT INTO migrations VALUES(51,'2025_09_01_010400_create_order_shippings_table',1);
INSERT INTO migrations VALUES(52,'2025_09_01_010500_add_totals_columns_to_orders_table',1);
INSERT INTO migrations VALUES(53,'2025_09_01_020000_add_foreign_keys_and_more_indexes',1);
INSERT INTO migrations VALUES(54,'2025_09_01_050000_add_warehouse_quantity_to_products',1);
INSERT INTO migrations VALUES(55,'2025_09_01_190000_add_status_to_sh_product_variants_table',1);
INSERT INTO migrations VALUES(56,'2025_09_01_191000_create_variant_inventories_table',1);
INSERT INTO migrations VALUES(57,'2025_09_02_130000_test_support_columns',1);
INSERT INTO migrations VALUES(58,'2025_09_02_151200_create_customers_table',1);
INSERT INTO migrations VALUES(59,'2025_09_02_151538_create_new_ecommerce_tables',1);
INSERT INTO migrations VALUES(60,'2025_09_02_151539_add_request_fields_to_products_table',1);
INSERT INTO migrations VALUES(61,'2025_09_02_151539_create_coupon_relationships_tables',1);
INSERT INTO migrations VALUES(62,'2025_09_02_151540_create_product_requests_table',1);
INSERT INTO migrations VALUES(63,'2025_09_02_151541_create_product_histories_table',1);
INSERT INTO migrations VALUES(64,'2025_09_02_151542_create_product_history_translations_table',1);
INSERT INTO migrations VALUES(65,'2025_09_02_155500_create_missing_core_tables',1);
INSERT INTO migrations VALUES(66,'2025_09_02_160313_remove_sh_prefix_from_all_tables',1);
INSERT INTO migrations VALUES(67,'2025_09_02_160314_add_multi_language_fields_to_discount_codes_table',1);
INSERT INTO migrations VALUES(68,'2025_09_02_160315_enhance_discount_conditions_table',1);
INSERT INTO migrations VALUES(69,'2025_09_02_160316_add_translatable_fields_to_price_list_items_table',1);
INSERT INTO migrations VALUES(70,'2025_09_02_160317_update_price_lists_table_add_translations',1);
INSERT INTO migrations VALUES(71,'2025_09_02_160318_create_discount_redemption_translations_table',1);
INSERT INTO migrations VALUES(72,'2025_09_02_160319_enhance_campaigns_system',1);
INSERT INTO migrations VALUES(73,'2025_09_02_160320_enhance_campaign_clicks_table',1);
INSERT INTO migrations VALUES(74,'2025_09_02_160321_enhance_campaign_translations',1);
INSERT INTO migrations VALUES(75,'2025_09_02_160322_create_discount_condition_translations_table',1);
INSERT INTO migrations VALUES(76,'2025_09_02_160324_create_price_list_item_translations_table',1);
INSERT INTO migrations VALUES(77,'2025_09_02_162921_create_country_translations_table',1);
INSERT INTO migrations VALUES(78,'2025_09_02_163244_add_timestamps_to_countries_table',1);
INSERT INTO migrations VALUES(79,'2025_09_02_170656_remove_remaining_sh_prefixes_from_tables',1);
INSERT INTO migrations VALUES(80,'2025_09_02_215149_create_activity_log_table',1);
INSERT INTO migrations VALUES(81,'2025_09_02_215150_add_event_column_to_activity_log_table',1);
INSERT INTO migrations VALUES(82,'2025_09_02_215151_add_batch_uuid_column_to_activity_log_table',1);
...
INSERT INTO migrations VALUES(85,'2025_09_02_220236_create_permission_tables',2);
INSERT INTO migrations VALUES(86,'2025_09_03_000001_add_enhanced_filament_features',3);
INSERT INTO migrations VALUES(87,'2025_09_03_000001_create_currencies_table',3);
INSERT INTO migrations VALUES(88,'2025_09_03_000002_create_prices_table',3);
INSERT INTO migrations VALUES(89,'2025_09_03_000003_add_translation_support_to_prices_table',3);
INSERT INTO migrations VALUES(90,'2025_09_03_000004_create_currency_translations_table',3);
INSERT INTO migrations VALUES(91,'2025_09_03_000005_enhance_filament_tables',3);
INSERT INTO migrations VALUES(92,'2025_09_03_000006_create_attribute_value_translations_table',3);
INSERT INTO migrations VALUES(93,'2025_09_03_000007_enhance_product_variants_system',3);
INSERT INTO migrations VALUES(94,'2025_09_03_000010_create_location_translations_table',3);
INSERT INTO migrations VALUES(95,'2025_09_03_000011_create_enhanced_filament_ecommerce_system',3);
INSERT INTO migrations VALUES(96,'2025_09_03_000012_create_recommendation_system_tables',3);
INSERT INTO migrations VALUES(97,'2025_09_03_000013_enhance_product_variants_comprehensive',3);
INSERT INTO migrations VALUES(98,'2025_09_03_000014_create_cities_table',3);
INSERT INTO migrations VALUES(99,'2025_09_03_000015_create_city_translations_table',3);
INSERT INTO migrations VALUES(100,'2025_09_03_000017_update_addresses_table_for_locations',3);
INSERT INTO migrations VALUES(101,'2025_09_03_000018_create_referral_system_tables',3);
INSERT INTO migrations VALUES(102,'2025_09_03_000021_add_translation_fields_to_referral_rewards',3);
INSERT INTO migrations VALUES(103,'2025_09_03_000022_add_translation_fields_to_referrals_table',3);
INSERT INTO migrations VALUES(104,'2025_09_03_000023_create_referral_reward_logs_table',3);
INSERT INTO migrations VALUES(105,'2025_09_03_000024_enhance_campaign_conversions_table',3);
INSERT INTO migrations VALUES(106,'2025_09_03_000025_enhance_product_translations_table',3);
INSERT INTO migrations VALUES(107,'2025_09_03_000026_create_order_translations_table',3);
INSERT INTO migrations VALUES(108,'2025_09_03_000027_create_location_translations_table',3);
INSERT INTO migrations VALUES(109,'2025_09_03_000028_add_missing_columns_to_locations_table',3);
INSERT INTO migrations VALUES(110,'2025_09_03_000029_upgrade_models_and_add_missing_relations',3);
INSERT INTO migrations VALUES(111,'2025_09_03_100000_update_referrals_indexes',3);
INSERT INTO migrations VALUES(112,'2025_09_03_120000_enhance_filament_tables',3);
INSERT INTO migrations VALUES(113,'2025_09_03_120001_add_enhanced_fields_to_attributes_table',3);
INSERT INTO migrations VALUES(114,'2025_09_03_120001_add_translations_to_customer_groups_table',3);
INSERT INTO migrations VALUES(115,'2025_09_03_223900_add_deleted_at_to_product_variants_table',3);
INSERT INTO migrations VALUES(116,'2025_09_03_230000_add_missing_review_columns',3);
INSERT INTO migrations VALUES(117,'2025_09_03_230100_create_order_items_table',3);
INSERT INTO migrations VALUES(118,'2025_09_03_230200_create_review_translations_table',3);
INSERT INTO migrations VALUES(119,'2025_09_03_230500_add_foreign_keys_to_stock_reservations_table',3);
INSERT INTO migrations VALUES(120,'2025_09_04_000000_enhance_filament_system_final',3);
INSERT INTO migrations VALUES(121,'2025_09_04_120000_add_is_featured_to_price_list_items_table',3);
INSERT INTO migrations VALUES(122,'2025_09_04_121000_add_deleted_at_to_price_lists_table',3);
INSERT INTO migrations VALUES(123,'2025_09_04_163608_create_notifications_table',3);
INSERT INTO migrations VALUES(124,'2025_09_04_170000_create_countries_table',3);
INSERT INTO migrations VALUES(125,'2025_09_04_170001_add_missing_fields_to_countries_table',3);
INSERT INTO migrations VALUES(126,'2025_09_04_170001_enhance_countries_table',3);
INSERT INTO migrations VALUES(127,'2025_09_04_175155_add_missing_columns_to_order_shippings_table',3);
INSERT INTO migrations VALUES(128,'2025_09_04_180000_update_countries_table_structure',3);
INSERT INTO migrations VALUES(129,'2025_09_04_200000_add_multilanguage_support_to_enhanced_settings',3);
INSERT INTO migrations VALUES(130,'2025_09_05_000000_add_is_active_to_enhanced_settings_table',3);
INSERT INTO migrations VALUES(131,'2025_09_05_000001_add_is_enabled_to_categories',3);
INSERT INTO migrations VALUES(132,'2025_09_08_193000_align_order_items_columns',3);
INSERT INTO migrations VALUES(133,'2025_09_08_194200_add_price_column_to_order_items',3);
INSERT INTO migrations VALUES(134,'2025_09_08_225900_add_missing_columns_to_settings_table',3);
INSERT INTO migrations VALUES(135,'2025_09_08_230000_add_is_admin_to_users_table',3);
INSERT INTO migrations VALUES(136,'2025_09_09_000000_add_soft_deletes_to_users_table',3);
INSERT INTO migrations VALUES(137,'2025_09_09_000000_create_discounts_table',3);
INSERT INTO migrations VALUES(138,'2025_09_09_000000_create_reports_table',3);
INSERT INTO migrations VALUES(139,'2025_09_09_000001_create_product_images_table',3);
INSERT INTO migrations VALUES(140,'2025_09_09_000001_optimize_media_indexes',3);
INSERT INTO migrations VALUES(141,'2025_09_09_000001_update_campaigns_add_fields_and_translations',3);
INSERT INTO migrations VALUES(142,'2025_09_09_000002_optimize_customer_relations',3);
INSERT INTO migrations VALUES(143,'2025_09_09_000003_optimize_core_indexes',3);
INSERT INTO migrations VALUES(144,'2025_09_09_000040_create_discount_conditions_table',3);
INSERT INTO migrations VALUES(145,'2025_09_09_000050_create_channels_table',3);
INSERT INTO migrations VALUES(146,'2025_09_09_000100_create_inventories_tables',3);
INSERT INTO migrations VALUES(147,'2025_09_09_000101_enhance_variant_inventories_table',3);
INSERT INTO migrations VALUES(148,'2025_09_09_000102_update_stock_tables_for_comprehensive_management',3);
INSERT INTO migrations VALUES(149,'2025_09_09_000103_add_sku_column_to_inventories_table',3);
INSERT INTO migrations VALUES(150,'2025_09_09_061900_update_partner_tiers_schema',3);
INSERT INTO migrations VALUES(151,'2025_09_09_061950_update_partners_schema',3);
INSERT INTO migrations VALUES(152,'2025_09_09_072000_update_partners_add_missing_columns',3);
INSERT INTO migrations VALUES(153,'2025_09_09_120000_add_soft_deletes_to_discount_campaigns_table',3);
...
INSERT INTO migrations VALUES(161,'2025_09_10_001200_create_news_additional_tables',3);
INSERT INTO migrations VALUES(162,'2025_09_10_100000_create_menus_table',3);
INSERT INTO migrations VALUES(163,'2025_09_10_100100_create_menu_items_table',3);
INSERT INTO migrations VALUES(164,'2025_09_12_061724_create_legals_table',3);
INSERT INTO migrations VALUES(165,'2025_09_12_070041_add_deleted_at_to_addresses_table',3);
INSERT INTO migrations VALUES(166,'2025_09_12_075952_add_warehouse_quantity_to_products_table_after_rename',3);
INSERT INTO migrations VALUES(167,'2025_09_12_173543_create_locations_table',3);
INSERT INTO migrations VALUES(168,'2025_09_12_200000_create_posts_table',3);
INSERT INTO migrations VALUES(169,'2025_09_12_200001_add_translations_to_posts_table',3);
INSERT INTO migrations VALUES(170,'2025_09_13_123340_add_enhanced_fields_to_addresses_table',3);
INSERT INTO migrations VALUES(171,'2025_09_13_181846_add_soft_deletes_to_referral_rewards_table',3);
INSERT INTO migrations VALUES(172,'2025_09_13_184525_add_missing_columns_to_attribute_values_table',3);
INSERT INTO migrations VALUES(173,'2025_09_13_185602_add_missing_columns_to_campaign_conversion_translations_table',3);
INSERT INTO migrations VALUES(174,'2025_09_13_185848_add_missing_columns_to_cart_items_table',3);
INSERT INTO migrations VALUES(175,'2025_09_13_190134_add_missing_columns_to_channels_table',3);
INSERT INTO migrations VALUES(176,'2025_09_13_190421_create_channel_product_table',3);
INSERT INTO migrations VALUES(177,'2025_09_13_191437_add_missing_columns_to_cities_table',3);
INSERT INTO migrations VALUES(178,'2025_09_13_191643_add_is_active_to_cities_table',3);
INSERT INTO migrations VALUES(179,'2025_09_13_191719_add_is_active_to_collections_table',3);
INSERT INTO migrations VALUES(180,'2025_09_13_191817_add_missing_columns_to_collections_table',3);
INSERT INTO migrations VALUES(181,'2025_09_13_192158_add_meta_fields_to_collection_translations_table',3);
INSERT INTO migrations VALUES(182,'2025_09_14_062324_add_user_id_to_notifications_table',3);
INSERT INTO migrations VALUES(183,'2025_09_14_075827_update_feature_flags_table_add_missing_columns',3);
INSERT INTO migrations VALUES(184,'2025_09_14_125040_create_subscribers_table',3);
INSERT INTO migrations VALUES(185,'2025_09_14_133055_create_admin_users_table',3);
INSERT INTO migrations VALUES(186,'2025_09_14_134342_add_advanced_fields_to_recommendation_configs_table',3);
INSERT INTO migrations VALUES(187,'2025_09_14_163054_create_email_campaigns_table',3);
INSERT INTO migrations VALUES(188,'2025_09_14_163205_add_user_id_to_subscribers_table',3);
INSERT INTO migrations VALUES(189,'2025_09_14_163833_create_companies_table',3);
INSERT INTO migrations VALUES(190,'2025_09_14_164105_add_deleted_at_to_subscribers_table',3);
INSERT INTO migrations VALUES(191,'2025_09_14_171732_add_is_active_to_attributes_table',3);
INSERT INTO migrations VALUES(192,'2025_09_14_173845_add_is_active_to_discount_campaigns_table',3);
INSERT INTO migrations VALUES(193,'2025_09_14_191939_add_missing_columns_to_reviews_table',3);
INSERT INTO migrations VALUES(194,'2025_09_14_204041_remove_regions_from_cities_and_addresses_tables',3);
INSERT INTO migrations VALUES(195,'2025_09_18_000001_add_views_count_to_products_table',3);
INSERT INTO migrations VALUES(196,'2025_09_18_112935_fix_discount_codes_foreign_key_constraint',3);
INSERT INTO migrations VALUES(197,'2025_09_18_115829_add_is_featured_to_brands_table',3);
INSERT INTO migrations VALUES(198,'2025_09_18_115944_create_brands_table',3);
INSERT INTO migrations VALUES(199,'2025_09_18_152512_add_views_count_to_products_table',3);
INSERT INTO migrations VALUES(200,'2025_09_18_162441_add_is_visible_to_brands_table',3);
INSERT INTO migrations VALUES(201,'2025_09_18_170514_create_campaign_discount_table',3);
INSERT INTO migrations VALUES(202,'2025_09_18_175057_add_foreign_keys_to_campaign_discount_table',3);
INSERT INTO migrations VALUES(203,'2025_09_19_035640_create_sliders_table',3);
INSERT INTO migrations VALUES(204,'2025_09_19_040159_create_slider_translations_table',3);
INSERT INTO migrations VALUES(205,'2025_09_19_140000_create_zones_table',3);
INSERT INTO migrations VALUES(206,'2025_09_19_145445_create_shipping_options_table',3);
INSERT INTO migrations VALUES(207,'2025_09_19_145537_add_shipping_option_id_to_orders_table',3);
INSERT INTO migrations VALUES(208,'2025_09_19_191025_add_is_active_and_is_visible_to_brands_table',3);
INSERT INTO migrations VALUES(209,'2025_09_19_191822_create_discount_condition_products_table',3);
INSERT INTO migrations VALUES(210,'2025_09_19_191845_create_discount_condition_categories_table',3);
INSERT INTO migrations VALUES(211,'2025_09_19_192227_add_minimum_quantity_to_cart_items_table',3);
INSERT INTO migrations VALUES(212,'2025_09_19_192236_add_enhanced_fields_to_activity_log_table',3);
INSERT INTO migrations VALUES(213,'2025_09_19_192620_add_enhanced_fields_to_analytics_events_table',3);
INSERT INTO migrations VALUES(214,'2025_09_19_192712_add_deleted_at_to_cart_items_table',3);
INSERT INTO migrations VALUES(215,'2025_09_19_193000_add_missing_location_columns',3);
INSERT INTO migrations VALUES(216,'2025_09_19_194023_add_notes_column_to_order_items_table',3);
INSERT INTO migrations VALUES(217,'2025_09_19_194100_recreate_locations_table',3);
INSERT INTO migrations VALUES(218,'2025_09_19_201726_create_enum_values_table',3);
INSERT INTO migrations VALUES(219,'2025_09_19_231559_add_missing_columns_to_campaign_customer_segments_table',3);
INSERT INTO migrations VALUES(220,'2025_09_19_232937_create_recommendation_config_simple_table',3);
INSERT INTO migrations VALUES(221,'2025_09_19_234624_add_type_and_position_to_recommendation_blocks_table',3);
INSERT INTO migrations VALUES(222,'2025_09_19_235216_add_description_to_menus_table',3);
INSERT INTO migrations VALUES(223,'2025_09_20_000001_create_zones_table',3);
INSERT INTO migrations VALUES(224,'2025_09_20_000001_update_feature_flag_attribution_columns',3);
INSERT INTO migrations VALUES(225,'2025_09_20_000200_add_status_and_priority_to_discount_conditions',3);
INSERT INTO migrations VALUES(226,'2025_09_20_020500_fix_news_table_names',3);
INSERT INTO migrations VALUES(227,'2025_09_21_000500_add_discount_amount_to_cart_items_table',3);
INSERT INTO migrations VALUES(228,'2025_09_21_000500_optimize_menu_indexes',3);
INSERT INTO migrations VALUES(229,'2025_09_22_140300_add_is_default_and_nullable_pivots',3);
INSERT INTO migrations VALUES(230,'2025_09_24_000001_create_system_setting_histories_table',3);
INSERT INTO migrations VALUES(231,'2025_09_24_131300_add_missing_columns_to_documents_table',3);
INSERT INTO migrations VALUES(232,'2025_09_24_140000_update_recommendation_configs_and_pivots',3);
INSERT INTO migrations VALUES(233,'2025_09_24_142600_create_recommendation_block_products_table',3);
INSERT INTO migrations VALUES(234,'2025_09_24_142700_add_flags_to_recommendation_blocks_table',3);
INSERT INTO migrations VALUES(235,'2025_09_24_150500_add_is_active_to_news_tables',3);
INSERT INTO migrations VALUES(236,'2025_09_24_150600_create_collection_rules_table',3);
INSERT INTO migrations VALUES(237,'2025_09_24_181700_add_min_max_length_to_attributes_table',3);
INSERT INTO migrations VALUES(238,'2025_09_24_192722_add_missing_columns_to_category_translations',3);
INSERT INTO migrations VALUES(239,'2025_09_24_220500_optimize_campaign_indexes',3);
INSERT INTO migrations VALUES(240,'2025_09_25_000001_add_flags_to_subscribers_table',3);
...
INSERT INTO migrations VALUES(248,'2025_09_30_000001_add_valueable_columns_to_attribute_values_table',3);
INSERT INTO migrations VALUES(249,'2025_09_30_120000_add_is_featured_to_price_list_items_table',3);
INSERT INTO migrations VALUES(250,'2025_09_30_120000_enforce_order_shipping_constraints',3);
INSERT INTO migrations VALUES(251,'2025_09_30_121500_enforce_order_item_constraints',3);
INSERT INTO migrations VALUES(252,'2025_10_01_000000_add_moderation_to_marketing_content',3);
INSERT INTO migrations VALUES(253,'2025_10_05_000001_add_missing_columns_to_variant_images_table',3);
INSERT INTO migrations VALUES(254,'2025_10_10_000000_add_correlation_id_to_stock_movements_table',3);
INSERT INTO migrations VALUES(255,'2025_10_10_000200_optimize_menu_indexes',3);
INSERT INTO migrations VALUES(256,'2025_10_15_000000_add_additional_columns_to_variant_images_table',3);
INSERT INTO migrations VALUES(257,'2025_10_15_000500_add_soft_deletes_to_news_table',3);
INSERT INTO migrations VALUES(258,'2025_10_20_000001_add_cost_column_to_order_shippings_table',3);
INSERT INTO migrations VALUES(259,'2025_10_20_000001_update_campaign_product_targets_table',3);
INSERT INTO migrations VALUES(260,'2025_10_20_073213_create_exports_table',3);
INSERT INTO migrations VALUES(261,'2025_10_20_073425_create_contact_messages_table',3);
INSERT INTO migrations VALUES(262,'2025_10_20_091207_convert_feature_flag_attribution_columns',3);
INSERT INTO migrations VALUES(263,'2025_10_20_120000_add_matrix_columns_to_core_tables',3);
INSERT INTO migrations VALUES(264,'2025_10_23_000001_add_customer_group_to_coupons_table',3);
INSERT INTO migrations VALUES(265,'2025_10_23_120000_adjust_campaign_customer_segment_indexes',3);
INSERT INTO migrations VALUES(266,'2025_10_23_164819_update_variant_price_history_schema',3);
INSERT INTO migrations VALUES(267,'2025_10_23_185200_add_is_active_to_users_table',3);
INSERT INTO migrations VALUES(268,'2025_10_24_000001_create_discount_customer_groups_table',3);
INSERT INTO migrations VALUES(269,'2025_10_25_000000_rebuild_discount_schema',3);
INSERT INTO migrations VALUES(270,'2025_10_25_010000_add_metadata_to_user_product_interactions_table',3);
INSERT INTO migrations VALUES(271,'2025_10_26_000000_create_dead_letter_jobs_table',3);
INSERT INTO migrations VALUES(272,'2025_10_26_000001_add_admin_fields_to_email_campaigns',3);
INSERT INTO migrations VALUES(273,'2025_10_26_120000_add_name_attribution_columns_to_discount_tables',3);
INSERT INTO migrations VALUES(274,'2025_10_27_105234_add_timestamps_to_campaign_conversions_table',3);
INSERT INTO migrations VALUES(275,'2025_10_30_000000_add_country_city_columns_for_zone_removal',3);
INSERT INTO migrations VALUES(276,'2025_10_30_000000_add_is_breaking_to_news_table',3);
INSERT INTO migrations VALUES(277,'2025_10_30_000001_add_flags_to_campaign_conversions_table',3);
INSERT INTO migrations VALUES(278,'2025_10_30_000001_create_region_translations_table',3);
INSERT INTO migrations VALUES(279,'2025_10_30_010000_backfill_country_city_from_zones',3);
INSERT INTO migrations VALUES(280,'2025_10_30_080000_create_email_campaign_recipients_table',3);
INSERT INTO migrations VALUES(281,'2025_10_30_090100_add_permissions_matrix_to_roles_table',3);
INSERT INTO migrations VALUES(282,'2025_10_30_120000_fix_news_category_columns',3);
INSERT INTO migrations VALUES(283,'2025_10_30_120001_add_shipping_matrix_to_shipping_options_table',3);
INSERT INTO migrations VALUES(284,'2025_10_31_000000_create_table_settings_table',3);
INSERT INTO migrations VALUES(285,'2025_11_03_000002_add_attribution_names_to_system_settings_table',3);
INSERT INTO migrations VALUES(286,'2025_11_05_120000_expand_order_status_options',3);
INSERT INTO migrations VALUES(287,'2025_11_06_120000_expand_product_status_column',3);
INSERT INTO migrations VALUES(288,'2025_11_06_130000_create_product_variant_translations_table',3);
INSERT INTO migrations VALUES(289,'2025_11_07_000001_add_schedule_columns_to_price_lists_table',3);
INSERT INTO migrations VALUES(290,'2025_11_10_000001_add_description_and_meta_data_to_attribute_value_translations_table',3);
INSERT INTO migrations VALUES(291,'2025_11_10_000200_enforce_order_schema_constraints',3);
INSERT INTO migrations VALUES(292,'2025_11_12_000001_add_attribution_names_to_documents_table',3);
INSERT INTO migrations VALUES(293,'2025_11_15_000000_update_user_product_interactions_table',3);
INSERT INTO migrations VALUES(294,'2025_11_20_000500_add_meta_columns_to_categories_table',3);
INSERT INTO migrations VALUES(295,'2025_11_30_000600_add_meta_columns_to_brands_table',3);
INSERT INTO migrations VALUES(296,'2025_11_30_000700_add_contact_details_to_brands_table',3);
INSERT INTO migrations VALUES(297,'2025_12_01_000000_create_payment_webhook_events_table',3);
INSERT INTO migrations VALUES(298,'2025_12_15_000100_ensure_legacy_attribute_tables_exist',3);
INSERT INTO migrations VALUES(300,'2025_12_15_192103_create_performance_metrics_table',4);
