...
- Discounts/Campaigns: `AdminPresetDiscountsSeeder`, `CampaignSeeder`, `CampaignClickSeeder` (now auto-creates seed campaigns so click data is always generated), `DiscountCodeSeeder`, `GroupSeeder`, `PartnerSeeder`
