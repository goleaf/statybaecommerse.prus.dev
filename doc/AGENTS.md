...
- Variant analytics unit tests now centralize deterministic factories via the `createAnalytics` and `createAnalyticsForDate` helpers; reuse them to keep bucket and rate assertions stable across database drivers.
