...
- Campaign schedule filtering accepts arrays of enum or string identifiers so marketing automation jobs can query multiple cadence types in a single scope call without bespoke SQL.【F:app/Models/CampaignSchedule.php†L110-L176】
