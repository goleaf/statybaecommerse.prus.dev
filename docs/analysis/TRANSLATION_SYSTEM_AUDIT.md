...
- System setting translations normalise stored locale codes to lowercase on save, guaranteeing that analytics helpers and query scopes return deterministic results even when administrators provide uppercase variants through the UI.【F:app/Models/SystemSettingTranslation.php†L38-L56】
