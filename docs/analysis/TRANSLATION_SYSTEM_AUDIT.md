...
- Attribute helpers on `SystemSettingCategory` now reuse eager-loaded translation relations before issuing fallback queries, preventing N+1 lookups when Blade templates or Filament resources iterate across multiple locales.【F:app/Models/SystemSettingCategory.php†L197-L232】
