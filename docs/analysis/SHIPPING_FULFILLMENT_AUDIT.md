...
- Authenticated customers and support agents can now fetch `/api/orders/{order}` for shipping updates; the controller permits completed orders and returns schema-aligned payloads for downstream tracking surfaces.【F:routes/api.php†L72-L83】【F:app/Http/Controllers/Api/OrderController.php†L30-L88】【F:app/Support/Contracts/Entities/OrderContract.php†L53-L101】
