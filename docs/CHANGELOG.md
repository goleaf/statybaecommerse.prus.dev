...
### Changed
- Replaced the Variant Inventory form's nested grids with section column layouts to clarify bespoke spans and keep component imports aligned with the refactored schema.
