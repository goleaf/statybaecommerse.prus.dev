...
### Changed
- Documented the Collection Rule navigation icon hook, refreshed its Filament v4 form/table signatures, and converted reorder to a modal action while updating admin pages to drop legacy form array returns.
